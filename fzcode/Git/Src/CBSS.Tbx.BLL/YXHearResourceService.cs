...
namespace CBSS.Tbx.BLL
{
    public partial class TbxService : ITbxService
    {
        ...
        public IEnumerable<v_SecondModule> GetYXHearResource(v_ModuleInfo param, List<v_ListSubModules_0> hearResources)
        {
            #region 目录对象
            ...
            foreach (var model in listSubModules)
            {
                ...
                sqlString += "SELECT MAX(PlayTimes) FROM [FZ_CBSS_HearResourceRecords].[dbo].[TB_UserHearResources_YX] where 1=1";
                ...
                #region 用户最优5次的成绩
                // questString = "";
                questString += "SELECT TOP 5  CreateTime,AverageScore FROM [FZ_CBSS_HearResourceRecords].[dbo].[TB_UserHearResources_YX] where 1=1";
        ...
        public IEnumerable<TB_HearResources_YX> GetYXUserHearResourcesList(string where)
        {
            return HearResourceRepository.SelectSearch<TB_HearResources_YX>(where);
        }

        public bool AddYXResources(TB_HearResources_YX tB_UserHearResources)
        {
            return (int)HearResourceRepository.Insert(tB_UserHearResources)>0;
        }


        public  void GetYXUserHearResourcesInfo(v_ModuleInfo submitData, List<v_ListenSpeakInfo> hr, out int finishedTimes)
        {
        ...
        public List<HearResourceInfoModel> GetYXHearResourceByWeb(string UserID, int BookID, int FirstTitleID, int SecondTitleID, List<v_ListSubModules_0> list)
        {
            ...
            if (list != null && list.Count > 0)
            {
                ...
                {
                    string questString = "";
                    questString = "SELECT TOP 1 * FROM [FZ_HearResources].[dbo].[TB_UserHearResources_YX] where 1=1";
