...
namespace CBSS.Web.API.Controllers
{
    ...
    {
        [HttpPost]
        public static APIResponse GetInterestDubbingRecord()
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse GetDubbingByCataId(string inputStr)
        {
            v_BookInfo input;
            var verifyResult = tbxService.VerifyParam<v_BookInfo>(inputStr, out input, new List<string> { "SecondTitleID" });
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse GetVideoList(string inputStr)
        {
            VideoRequset input;
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse UpdateVedioInfo(string inputStr)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse InsertVideoInfo(string inputStr)
        {
            UserVideoInfo input;
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse SchoolRankInfo(string inputStr)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse ClassRankInfo(string inputStr)
        {
            UserSchoolRankParaModel input;
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse NewRankInfo(string inputStr)
        {
            UserSchoolRankParaModel input;
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse VideoRankingInfo(string inputStr)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse VideoAchievementInfo(string inputStr)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public static APIResponse AddNumberOfOraise(string inputStr)
        {
