    ...
    Tree.prototype.deleteNode = function (identifiers, options) {
        this.forEachIdentifier(identifiers, options, $.proxy(function (node, options) {
            ...
            if (parentNode && parentNode.nodes != null) {
                ...
                console.log('root node cannot delete');
            }
        }, this));
    };
	...
	*/
    Tree.prototype.setInitialStates = function (node, level) {
        ...
        $.each(node.nodes, function checkStates(index, node) {
            ...
            if (!node.state.hasOwnProperty('showcheckbox')) {
                node.state.showcheckbox = false;
            }
        ...
        $.each(nodes, function addNodes(id, node) {
            ...
            if (_this.options.showCheckbox) {
                ...
                if (node.state.checked) {
                    ...
                    if (!node.state.showcheckbox) {//是否呈现复选按钮  true 不呈现
