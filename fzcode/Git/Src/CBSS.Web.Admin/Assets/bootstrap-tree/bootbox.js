...
function addcloud() {//增加页面遮罩
    ...
    loadingObj.innerHTML = "<img style='width:36px;' src=\"/Content/loadmask/images/loader.gif\" /><p style='color:white; float:right;   margin-top:8px;'>" + "Loading pages..." + "</P>";//showName
    loadingObj.style.padding = "20px";
    loadingObj.style.width = "206px";
    loadingObj.style.height = "76px";
