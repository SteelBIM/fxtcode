...
var uploader = new plupload.Uploader({
    ...
    filters: {
        //mime_types: [
        //    { title: "GIF files", extensions: "gif" }, { title: "JPG files", extensions: "jpg" }, { title: "PNG files", extensions: "png" }, { title: "ZIP files", extensions: "zip" }, { title: "RAR files", extensions: "rar" } 
        //],
    ...
    init: {
        ...
        FileUploaded: function (up, file, info) {//文件已上传成功
            ...
            $("#ModuleImg").val("http://tbxcdn.kingsun.cn/" + get_uploaded_object_name(file.name));//模块图片地址
            $("#ImgPath").val("http://tbxcdn.kingsun.cn/" + get_uploaded_object_name(file.name));//图片库图片地址
            if (info.status == 200) {
...
//$(function () {
//    alert(1);
//    $('input[type="file"]').attr("accept", ".jpg");
//    alert(1);
//});
