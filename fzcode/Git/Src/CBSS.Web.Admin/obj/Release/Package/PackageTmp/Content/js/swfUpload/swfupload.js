...
SWFUpload.prototype.initSettings = function () {
    ...
    //this.ensureDefault("button_action", SWFUpload.BUTTON_ACTION.SELECT_FILES);//可以选择多个文件
    this.ensureDefault("button_action", SWFUpload.BUTTON_ACTION.SELECT_FILE); //只能单选文件上传
