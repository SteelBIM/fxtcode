...
function loadSkinCss() {
    ...
    if (cookie == ""||cookie==undefined) {
        loadStyleCss("mac"); //如果cookie中没有值，则调用默认皮肤样式表
    }
    else {
...
$.fn.ruleSingleHtmlCheckbox = function () {
    var singleHtmlCheckbox = function (checkboxObj) {
        ...
        $(newObj).click(function () {
            ...
            //artDialog.tips($(checkboxObj).prop("checked"));//选中项的值
           // artDialog.tips($(checkboxObj).val()); //选中项的值
        });
    };
    return $(this).each(function () {
    ...
    var multiHtmlCheckbox = function (parentObj) {
        ...
        parentObj.find(":checkbox").each(function () {
            ...
            $(newObj).click(function () {
                ...
                //artDialog.tips(parentObj.find(':checkbox').eq(indexNum).prop("checked"));
            });
        });
    };
    return $(this).each(function () {
    ...
    var multiRadio = function (parentObj) {
        ...
        parentObj.find('input[type="radio"]').each(function () {
            ...
            $(newObj).click(function () {
                ...
                //artDialog.tips(parentObj.find('input[type="radio"]').eq(indexNum).index());
            });
        });
    };
    return $(this).each(function () {
    ...
    var ruleHtmlSelect = function (selectObj) {
        ...
        selectObj.find("option").each(function (i) {
            ...
            liObj.click(function () {
                ...
                //artDialog.tips(selectObj.find("option:selected").text());
                //将点击事件公布出去，以进行其它的操作
...
function optionSelected(curObj, selectedIndex, selectedText) {
    //artDialog.tips("你当前选中的序号为：" + selectedIndex + " 文本为：" + selectedText);
    //    if ($(curObj).attr("id") == "ddlChannelId") {//联动刷新
    //        $("#ddlParentId").val(selectedIndex); 
    //    }
