...
#pragma warning disable CS1573 // 参数“toWord”在“HtmlDiff.HtmlDiff(string, string, bool)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning disable CS1574 // XML 注释中有未能解析的 cref 特性“Diff”
        /// <summary>
...
#pragma warning restore CS1574 // XML 注释中有未能解析的 cref 特性“Diff”
#pragma warning restore CS1573 // 参数“toWord”在“HtmlDiff.HtmlDiff(string, string, bool)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        {
...
#pragma warning disable CS1570 // XML 注释出现 XML 格式错误 --“结束标记“b”与开始标记“p”不匹配。”
        /// <summary>
...
#pragma warning restore CS1570 // XML 注释出现 XML 格式错误 --“结束标记“b”与开始标记“p”不匹配。”
        {
            while (true)
            {
                if (words.Count == 0)
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch”的 XML 注释
    public class DiffMatch
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch”的 XML 注释
    {
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch.DiffMatch(int, int, int)”的 XML 注释
        public DiffMatch(int startInOld, int startInNew, int size)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch.DiffMatch(int, int, int)”的 XML 注释
        {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch.StartInOld”的 XML 注释
        public int StartInOld { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch.StartInOld”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch.StartInNew”的 XML 注释
        public int StartInNew { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch.StartInNew”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch.Size”的 XML 注释
        public int Size { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch.Size”的 XML 注释

#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch.EndInOld”的 XML 注释
        public int EndInOld
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch.EndInOld”的 XML 注释
        {
            get
            {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMatch.EndInNew”的 XML 注释
        public int EndInNew
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMatch.EndInNew”的 XML 注释
        {
            get
            {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation”的 XML 注释
    public class DiffOperation
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation”的 XML 注释
    {
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation.Action”的 XML 注释
        public DiffAction Action { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation.Action”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation.StartInOld”的 XML 注释
        public int StartInOld { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation.StartInOld”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation.EndInOld”的 XML 注释
        public int EndInOld { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation.EndInOld”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation.StartInNew”的 XML 注释
        public int StartInNew { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation.StartInNew”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation.EndInNew”的 XML 注释
        public int EndInNew { get; set; }
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation.EndInNew”的 XML 注释

#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffOperation.DiffOperation(DiffAction, int, int, int, int)”的 XML 注释
        public DiffOperation(DiffAction action, int startInOld, int endInOld, int startInNew, int endInNew)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffOperation.DiffOperation(DiffAction, int, int, int, int)”的 XML 注释
        {
            this.Action = action;
            this.StartInOld = startInOld;
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMode”的 XML 注释
    public enum DiffMode
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMode”的 XML 注释
    {
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMode.character”的 XML 注释
        character,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMode.character”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMode.tag”的 XML 注释
        tag,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMode.tag”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffMode.whitespace”的 XML 注释
        whitespace,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffMode.whitespace”的 XML 注释
    }

#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffAction”的 XML 注释
    public enum DiffAction
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffAction”的 XML 注释
    {
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffAction.equal”的 XML 注释
        equal,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffAction.equal”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffAction.delete”的 XML 注释
        delete,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffAction.delete”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffAction.insert”的 XML 注释
        insert,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffAction.insert”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffAction.none”的 XML 注释
        none,
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffAction.none”的 XML 注释
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“DiffAction.replace”的 XML 注释
        replace
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“DiffAction.replace”的 XML 注释
    }
}
