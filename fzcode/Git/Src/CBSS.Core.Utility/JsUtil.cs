...
namespace CBSS.Core.Utility
{
    ...
    public class JsUtil
    {
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.AlertAndRedirect(string, string)”的 XML 注释
        public static void AlertAndRedirect(string message, string toURL)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.AlertAndRedirect(string, string)”的 XML 注释
        {
...
#pragma warning disable CS0618 // “Page.RegisterHiddenField(string, string)”已过时:“The recommended alternative is ClientScript.RegisterHiddenField(string hiddenFieldName, string hiddenFieldInitialValue). http://go.microsoft.com/fwlink/?linkid=14202”
            page.RegisterHiddenField("__EVENTTARGET", "");
#pragma warning restore CS0618 // “Page.RegisterHiddenField(string, string)”已过时:“The recommended alternative is ClientScript.RegisterHiddenField(string hiddenFieldName, string hiddenFieldInitialValue). http://go.microsoft.com/fwlink/?linkid=14202”
#pragma warning disable CS0618 // “Page.RegisterHiddenField(string, string)”已过时:“The recommended alternative is ClientScript.RegisterHiddenField(string hiddenFieldName, string hiddenFieldInitialValue). http://go.microsoft.com/fwlink/?linkid=14202”
...
#pragma warning disable CS0618 // “Page.RegisterStartupScript(string, string)”已过时:“The recommended alternative is ClientScript.RegisterStartupScript(Type type, string key, string script). http://go.microsoft.com/fwlink/?linkid=14202”
            page.RegisterStartupScript("sds", s);
#pragma warning restore CS0618 // “Page.RegisterStartupScript(string, string)”已过时:“The recommended alternative is ClientScript.RegisterStartupScript(Type type, string key, string script). http://go.microsoft.com/fwlink/?linkid=14202”
        }
#pragma warning disable CS1572 // XML 注释中有“js”的 param 标记，但是没有该名称的参数
#pragma warning disable CS1573 // 参数“message”在“JsUtil.Alert(string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        /// <summary>
        /// 弹出JavaScript小窗口
        /// </summary>
        /// <param name="js">窗口信息</param>
        public static void Alert(string message)
#pragma warning restore CS1573 // 参数“message”在“JsUtil.Alert(string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning restore CS1572 // XML 注释中有“js”的 param 标记，但是没有该名称的参数
        {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.Alert(object)”的 XML 注释
        public static void Alert(object message)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.Alert(object)”的 XML 注释
        {
            string js = @"<Script language='JavaScript'>
                    alert('{0}');  
                  </Script>";
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.RtnRltMsgbox(object, string)”的 XML 注释
        public static void RtnRltMsgbox(object message, string strWinCtrl)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.RtnRltMsgbox(object, string)”的 XML 注释
        {
            string js = @"<Script language='JavaScript'>
					 strWinCtrl = true;
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.OpenWebForm(string, string, string)”的 XML 注释
        public static void OpenWebForm(string url, string name, string future)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.OpenWebForm(string, string, string)”的 XML 注释
        {
            string js = @"<Script language='JavaScript'>
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.OpenWebForm(string, string)”的 XML 注释
        public static void OpenWebForm(string url, string formName)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.OpenWebForm(string, string)”的 XML 注释
        {
            /*…………………………………………………………………………………………*/
            /*修改人员:		sxs						*/
            /*修改时间:	2003-4-9	*/
...
#pragma warning disable CS1572 // XML 注释中有“openerWindowUrl”的 param 标记，但是没有该名称的参数
#pragma warning disable CS1573 // 参数“frameName”在“JsUtil.ReplaceOpenerParentFrame(string, string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning disable CS1573 // 参数“frameWindowUrl”在“JsUtil.ReplaceOpenerParentFrame(string, string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        /// <summary>		
...
#pragma warning restore CS1573 // 参数“frameWindowUrl”在“JsUtil.ReplaceOpenerParentFrame(string, string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning restore CS1573 // 参数“frameName”在“JsUtil.ReplaceOpenerParentFrame(string, string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning restore CS1572 // XML 注释中有“openerWindowUrl”的 param 标记，但是没有该名称的参数
        {
            string js = @"<Script language='JavaScript'>
...
#pragma warning disable CS1573 // 参数“openerParentWindowUrl”在“JsUtil.ReplaceOpenerParentWindow(string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning disable CS1572 // XML 注释中有“openerWindowUrl”的 param 标记，但是没有该名称的参数
        /// <summary>		
        /// 函数名:ReplaceOpenerParentWindow	
        /// 功能描述:替换当前窗体的打开窗口的父窗口	
...
#pragma warning restore CS1572 // XML 注释中有“openerWindowUrl”的 param 标记，但是没有该名称的参数
#pragma warning restore CS1573 // 参数“openerParentWindowUrl”在“JsUtil.ReplaceOpenerParentWindow(string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        {
            string js = @"<Script language='JavaScript'>
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.CloseOpenerWindow()”的 XML 注释
        public static void CloseOpenerWindow()
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.CloseOpenerWindow()”的 XML 注释
        {
            string js = @"<Script language='JavaScript'>
                    window.opener.close();  
                  </Script>";
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.ShowModalDialogJavascript(string, string)”的 XML 注释
        public static string ShowModalDialogJavascript(string webFormUrl, string features)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.ShowModalDialogJavascript(string, string)”的 XML 注释
        {
            string js = @"<script language=javascript>							
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.ShowModalDialogWindow(string, string)”的 XML 注释
        public static void ShowModalDialogWindow(string webFormUrl, string features)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.ShowModalDialogWindow(string, string)”的 XML 注释
        {
            string js = ShowModalDialogJavascript(webFormUrl, features);
            HttpContext.Current.Response.Write(js);
        }
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.ShowModalDialogWindow(string, int, int, int, int)”的 XML 注释
        public static void ShowModalDialogWindow(string webFormUrl, int width, int height, int top, int left)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.ShowModalDialogWindow(string, int, int, int, int)”的 XML 注释
        {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“JsUtil.SetHtmlElementValue(string, string, string)”的 XML 注释
        public static void SetHtmlElementValue(string formName, string elementName, string elementValue)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“JsUtil.SetHtmlElementValue(string, string, string)”的 XML 注释
        {
