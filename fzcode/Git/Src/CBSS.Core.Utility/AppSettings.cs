...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“AppSettingsHelper.GetBoolValue(string)”的 XML 注释
        public static bool GetBoolValue(string key)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“AppSettingsHelper.GetBoolValue(string)”的 XML 注释
        {
            bool value = false;
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“AppSettingsHelper.GetIntValue(string)”的 XML 注释
        public static int GetIntValue(string key)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“AppSettingsHelper.GetIntValue(string)”的 XML 注释
        {
            int value = 0;
            if (appSettings[key] != null)
