...
#pragma warning disable CS1570 // XML 注释出现 XML 格式错误 --“引用未定义的实体“productid”。”
        /// <summary>
...
#pragma warning restore CS1570 // XML 注释出现 XML 格式错误 --“引用未定义的实体“productid”。”
        {
            var ids = Get(name);
            List<int> result = new List<int>();
            int id = 0;
        ...
        public static string ServerDomain
        {
            get
            {
                ...
                if ((urlHostArray.Length < 3) || RegHelper.IsIp(urlHost))
                {
                    return urlHost;
                }
