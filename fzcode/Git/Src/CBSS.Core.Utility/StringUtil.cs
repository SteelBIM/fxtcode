...
namespace CBSS.Core.Utility
{
    ...
    {
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringUtil.StringUtil()”的 XML 注释
        public StringUtil()
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringUtil.StringUtil()”的 XML 注释
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //			
...
#pragma warning disable CS1572 // XML 注释中有“stringArray”的 param 标记，但是没有该名称的参数
#pragma warning disable CS1573 // 参数“sourceString”在“StringUtil.GetStringCount(string, string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
        /// <summary>
        ///     获取某一字符串在字符串中出现的次数
        /// </summary>
        /// <param name="stringArray" type="string">
...
#pragma warning restore CS1573 // 参数“sourceString”在“StringUtil.GetStringCount(string, string)”的 XML 注释中没有匹配的 param 标记(但其他参数有)
#pragma warning restore CS1572 // XML 注释中有“stringArray”的 param 标记，但是没有该名称的参数
        {
            int count = 0;
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringUtil.GetSubString(string, string, string)”的 XML 注释
        public static string GetSubString(string sourceString, string beginRemovedString, string endRemovedString)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringUtil.GetSubString(string, string, string)”的 XML 注释
        {
            try
            {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringUtil.CutRightString(string, int)”的 XML 注释
        public static string CutRightString(string inputString, int len)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringUtil.CutRightString(string, int)”的 XML 注释
        {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringUtil.HtmlEncode(string, bool)”的 XML 注释
        public static string HtmlEncode(string str, bool encodeBlank = true)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringUtil.HtmlEncode(string, bool)”的 XML 注释
        {
            if ((str == "") || (str == null))
                return "";
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringUtil.TextEncode(string)”的 XML 注释
        public static string TextEncode(string s)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringUtil.TextEncode(string)”的 XML 注释
        {
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringUtil.Reverse(string)”的 XML 注释
        public static string Reverse(string s)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringUtil.Reverse(string)”的 XML 注释
        {
