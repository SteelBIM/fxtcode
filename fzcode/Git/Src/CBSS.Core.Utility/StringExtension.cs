...
{
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringExtension”的 XML 注释
    public static class StringExtension
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringExtension”的 XML 注释
    {
       /// <summary>
       /// 获取中文全拼
       /// </summary>
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“StringExtension.GetGradeName(int?)”的 XML 注释
       public static string GetGradeName(this int? GradeID)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“StringExtension.GetGradeName(int?)”的 XML 注释
       {
           string GradeName = "";
           switch (GradeID)
           {
