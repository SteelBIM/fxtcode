var SelectSchoolInit = function () {
        ...
        if (Current.districtID != "" && Current.districtID != "undefined" && Current.districtID != null) {
            Common.District.GetSchool(parseInt(Current.districtID.split('_')[1]), null, "", function (school) {
                ...
                if (provinceArr != null) {
                    ...
                    window.location.href =  Constant.classInfo_Url + "Account/AddInformation.html?provinceID=" + Current.provinceID + "&cityID=" + Current.cityID + "&districtID=" + Current.districtID + "&UserID=" + Current.UserID + "&TrueName=" + Current.TrueName;
                }
            });
        }//初始化地区数据
            ...
            Common.CodeAjax_City("do.area", parseInt(Current.cityID.split('_')[1]), function (data) {
                ...
                if (provinceArr != null) {
                    ...
                    window.location.href = Constant.classInfo_Url + "Account/AddInformation.html?provinceID=" + Current.provinceID + "&cityID=" + Current.cityID + "&UserID=" + Current.UserID + "&TrueName=" + Current.TrueName;
                }
            });
        }//初始化城市数据
            ...
            Common.CodeAjax_City("do.area", parseInt(Current.provinceID.split('_')[1]), function (data) {
                ...
                if (provinceArr != null) {
                    ...
                    window.location.href = Constant.classInfo_Url + "Account/AddInformation.html?provinceID=" + Current.provinceID + "&UserID=" + Current.UserID + "&TrueName=" + Current.TrueName;
                }
            });//初始化省份数据
        } else if (Current.provinceID == "" || Current.provinceID == "undefined" || Current.provinceID == null) {
            Common.CodeAjax_City("do.area", 0, function (data) {
                ...
                if (provinceArr != null) {
                    ...
                    window.location.href = Constant.classInfo_Url + "Account/AddInformation.html?UserID=" + Current.UserID + "&TrueName=" + Current.TrueName;
                }
            });
        }
    }
    ...
    this.InitStandBook = function () {
        ...
        var obj = { FunName: "GetAppList", Info: $.toJSON(data), FunWay: "0", Flag: "", Key: "" }
