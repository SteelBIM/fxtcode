...
window.LArea = (function () {
    ...
    MobileArea.prototype = {
        ...
        bindEvent: function () {
          ...
          '<div class="area_btn larea_finish" id="queding">确定</div>' +
          '</div>' +
          ...
          '</div>';
            ...
            function rollGear(target) {
                ...
                target["int_" + target.id] = setInterval(function () {
                    ...
                    switch (_self.type) {
                        case 1:
                            var minTop = -(eval(provs_data).length - 1) * 2;
                            break;
                        case 2:
                            var minTop = -(eval(city_data).length - 1) * 2;
                            break;
                        case 3:
                            var minTop = -(eval(qu_data).length - 1) * 2;
                            break;
                        case 4:
                            var minTop = -(eval(xiao_data).length - 1) * 2;
                            break;
                        case 5:
                            var minTop = -(eval(ban_data).length - 1) * 2;
                            break;
                        case 6:
                            var minTop = -((_self.data[0]).length - 1) * 2;
                            break;
        ...
        finish: function (e) {
            ...
            setTimeout(function () { _self.close(e) }, 500);
