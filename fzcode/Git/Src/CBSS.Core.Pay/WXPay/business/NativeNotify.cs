    ...
    public class NativeNotify : Notify
    {
        ...
        public override void ProcessNotify()
        {
            ...
            if (!notifyData.IsSet("openid") || !notifyData.IsSet("product_id"))
            {
                ...
                Log4NetHelper.Info(LoggerType.ApiExceptionLog, "The data WeChat post is error : " + res.ToXml(), null);
...
#pragma warning restore CS0168 // 声明了变量“ex”，但从未使用过
            {
                ...
                Log4NetHelper.Error(LoggerType.ApiExceptionLog, "UnifiedOrder failure : " + res.ToXml(), null);
                page.Response.Write(res.ToXml());
                page.Response.End();
            }
            ...
            Log4NetHelper.Info(LoggerType.ApiExceptionLog, "UnifiedOrder success , send data to WeChat : " + data.ToXml(), null);
