...
#pragma warning restore CS0168 // 声明了变量“ex”，但从未使用过
        ...
        public static bool RSACheckContent(string signContent, string sign, string publicKeyPem, string charset, string signType)
        {
            ...
            try
            {
                ...
                if ("RSA2".Equals(signType))
                {
                    string sPublicKeyPEM = File.ReadAllText("D:\\后台\\trunk\\Kingsun.SynchronousStudyIBS\\Kingsun.SynchronousStudy.Web\\Servers\\Kingsun.SynchronousStudy.App\\Keys\\rsa_public_key.pem");
