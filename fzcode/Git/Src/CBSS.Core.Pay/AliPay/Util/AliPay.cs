...
using System.Xml;
using CBSS.Core.Pay.AliPay.Util.Result;
...
namespace CBSS.Core.Pay.AliPay.Util
{
    ...
    public class AliPay
    {
        ...
        string _alipartnerid = XMLHelper.GetAppSetting(filepath, "AliPayConfig", "ali_partnerid");
        string _alikeycode = XMLHelper.GetAppSetting(filepath, "AliPayConfig", "ali_keycode");
        string _alipayway = XMLHelper.GetAppSetting(filepath, "AliPayConfig", "ali_payway");
