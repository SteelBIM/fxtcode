...
namespace CBSS.Tbx.Contract.ViewModel
{
    ...
    {
        public int BookID { get; set; }
#pragma warning disable CS0108 // “Rds_StudyReport_Book.ModuleType”隐藏继承的成员“Rds_StudyReport_Class.ModuleType”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 类型 1趣配音 2单元测试 3说说看
        /// </summary>
        public int ModuleType { get; set; }
#pragma warning restore CS0108 // “Rds_StudyReport_Book.ModuleType”隐藏继承的成员“Rds_StudyReport_Class.ModuleType”。如果是有意隐藏，请使用关键字 new。
    }
