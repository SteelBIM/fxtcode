...
$(function () {
    $.post("/AuthorityMgr/GetcurrentAction", function (data) {
        if (data != null && data != "") {
            ...
            if (jsonData.Add) {
                var dataaction = "<button style=\"background-color:#E16965;color:#fff; border-color:#E16965;\" onclick=\"location.href = '/AuthorityMgr/AuthorityMgr_Add'\" id=\"btn_add\" type=\"button\" class=\"btn btn-default\"><span class=\"glyphicon\" aria-hidden=\"true\"></span>新增员工角色 </button>"
