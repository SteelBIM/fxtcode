...
namespace KSWF.Web.Admin.App_Start
{
    ...
    public class StatisticsTrackerAttribute : ActionFilterAttribute, IExceptionFilter
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            MonLog.ExecuteStartTime = Convert.ToDateTime(DateTime.Now.ToString("yyyy-MM-dd HH:mm", DateTimeFormatInfo.InvariantInfo));
        ...
        public override void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            TestLog4Net.LogHelper.Monitor(MonLog.GetLoginfo());
        ...
        public override void OnResultExecuted(ResultExecutedContext filterContext)
        {
            MonitorLog MonLog = filterContext.Controller.ViewData[Key] as MonitorLog;
            MonLog.ExecuteEndTime = DateTime.Now;
            TestLog4Net.LogHelper.Monitor(MonLog.GetLoginfo(MonitorLog.MonitorType.View));
        ...
        public void OnException(ExceptionContext filterContext)
        {
            if (!filterContext.ExceptionHandled)
            {
                ...
                TestLog4Net.LogHelper.Error(ErrorMsg, filterContext.Exception);
            }
        }
        #endregion
