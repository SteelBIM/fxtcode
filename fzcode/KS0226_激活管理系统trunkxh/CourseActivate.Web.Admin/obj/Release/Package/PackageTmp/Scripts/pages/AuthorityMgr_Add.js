    ...
    $("#submit").click(function () {//提交
        ...
        $.post("/AuthorityMgr/GroupNameIsExist", { "groupid": groupid, "groupname": groupname }, function (IsExist) {
            if (IsExist > 0) {
                ...
                if (groupid > 0) {
                    $.post("/AuthorityMgr/AuthorityMgr_Edit", { "groupid": groupid, "groupname": groupname, "dataauthority": 0, "actions": action }, function (data) {
                        if (data > 0) {
                            if (data == 2) {
                                alert("编辑成功~");
                    ...
                    $.post("/AuthorityMgr/AuthorityMgr_Add", { "groupname": groupname, "dataauthority": 0, "actions": action }, function (data) {
                        if (data.Success) {
                            bootbox.alert("添加成功~");
                            location.href = "/AuthorityMgr/Index";
                        } else {
