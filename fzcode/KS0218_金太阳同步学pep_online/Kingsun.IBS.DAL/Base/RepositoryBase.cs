    ...
    public abstract class RepositoryBase<TEntity>:IRepositoryBase<TEntity> where TEntity : class,new()
    {
        ...
        public string ConnectionString
        {
            get
            {
                ...
                {
                    _connectionString = ConfigurationManager.ConnectionStrings["KingsunBaseDBConnectionStr"].ConnectionString;
                }
        ...
        public IEnumerable<TEntity> ExecuteProcedure(string procName, List<SqlParameter> pars = null)
        {
            using (var db = GetInstance())
            {
