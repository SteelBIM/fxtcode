    ...
    public sealed class SqlHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
                {
                    ...
                    _connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SpokenKingsunConnectionStr"].ConnectionString;
        ...
        public static string ExamConnectionString
        {
            get
            {
                ...
                {
                    string k = "KS0210KINGSUNSOFT2008123456789";
                    _examconnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["KingsunExamPaperConnectionStr"].ConnectionString;
                    //_connectionString = xxtea.Decrypt(_connectionString, k);
                }
                return _examconnectionString;
            }
        }
        public static string SpokenConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
        ...
        public static bool ExecuteNonQueryTransaction(string connectionString, List<string> list)
        {
