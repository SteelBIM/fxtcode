<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VideoStatistics.aspx.cs" Inherits="Kingsun.SynchronousStudy.Web.OperationStatistics.VideoStatistics" %>
            ...
            <asp:Repeater ID="rpStatistics" runat="server" >
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("ReleaseCount") %></td>
                        <td><%#Eval("ShareVideoNum") %></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </table>
