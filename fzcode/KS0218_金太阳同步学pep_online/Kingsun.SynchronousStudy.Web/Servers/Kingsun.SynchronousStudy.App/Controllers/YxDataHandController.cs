...
{
    public class YxDataHandController : ApiController
    {
        ...
        public HttpResponseMessage GetCatalogueLists([FromBody] KingRequest request)
        {
            ...
            try
            {
                ...
                where += "and b.Column_8 is not null"; 
        ...
        public HttpResponseMessage GetModuleConfigurationByFirstIDSecondID([FromBody] KingRequest request)
        {
            ...
            try
            {
                ...
                if (submitData.FirstTitleID != null) //传第一级模块标识
                {
                    ...
                    FilterForYX(modularlist);


                    List<object> obj = null;

                    #region 注释获取人教模块
                    //if (submitData.AppID == "5373bbc9-49d4-47df-b5b5-ae196dc23d6d")
                    //{
                    //    #region
                    //    //人教
        ...
        private void FilterForNotYX(List<TB_ModuleSort> modularlist)
        {
        ...
        [HttpGet]
        public HttpResponseMessage GetModuleConfigurationByFirstIDSecondIDtest()
        {
            string where = "";
            module submitData = new module();//JsonHelper.DecodeJson<TB_ModuleSort>(request.Data);
            submitData.BookID = 104;
            submitData.FirstTitleID = 272018;
            submitData.SecondTitleID = 272034;
            submitData.AppID = "5373bbc9-49d4-47df-b5b5-ae196dc23d6d";
