...
{
    public class HearResourcesController : ApiController
    {
        ...
        string SetSuishengting = WebConfigurationManager.AppSettings["sst"];
        ...
        public HttpResponseMessage GetListenSpeakAchievement([FromBody]KingRequest request)
        {
            ...
            try
            {
                ...
                if (hearResources == null)
                {
                    ...
                    --left join [FZ_HearResources].[dbo].[TB_UserHearResources] c on a.BookID=c.BookID and a.FirstTitleID=c.FirstTitleID and a.SecondTitleID=c.SecondTitleID 
                    where {0}
                ...
                if (hearResources != null && hearResources.Any())
                {
                    ...
                    foreach (var model in listSubModules)
                    {
                        ...
                        sqlString += "SELECT MAX(PlayTimes) FROM [FZ_HearResources].[dbo].[TB_UserHearResources] where 1=1";
                        ...
                        #region 用户最优5次的成绩
                        // questString = "";
                        questString += "SELECT TOP 5  CreateTime,AverageScore FROM [FZ_HearResources].[dbo].[TB_UserHearResources] where 1=1";
            ...
            try
            {
                ...
                if (hearResourceslist != null && hearResourceslist.Count > 0)
                {
                    ...
                    for (int i = 0, length = secondModuleIDArr.Length; i < length; i++)
                    {
                        ...
                        IList<TB_HearResources> resourceslist = hearResourcesBLL.GetModuleList(queryStr);
                        string queryString = "";
                        queryString = "1=1";
                        ...
                        secondModule.History = new List<SubModuleDetails>();
                        string questString = "";
                        questString = "SELECT TOP 5 * FROM [FZ_HearResources].[dbo].[TB_UserHearResources] where 1=1";
                        questString += " and UserID = " + ParseInt(submitData.UserID);
                        questString += " and BookID = " + ParseInt(submitData.BookID);
                        questString += " and FirstTitleID = " + ParseInt(submitData.FirstTitleID);
                        if (!string.IsNullOrEmpty(submitData.SecondTitleID))
                        ...
                        IList<TB_UserHearResources> resourcesList = DataSetToIList<TB_UserHearResources>(ds, 0);
                        string sqlString = "SELECT MAX(PlayTimes) FROM [FZ_HearResources].[dbo].[TB_UserHearResources] where 1=1";
                        sqlString += " and UserID = " + ParseInt(submitData.UserID);
                        sqlString += " and BookID = " + ParseInt(submitData.BookID);
                        sqlString += " and FirstTitleID = " + ParseInt(submitData.FirstTitleID);
                        if (!string.IsNullOrEmpty(submitData.SecondTitleID))
        ...
        public HttpResponseMessage GetListenSpeakListAgo([FromBody]KingRequest request)
        {
            ...
            try
            {
                ...
                IList<TB_HearResources> hr = bm.Search<TB_HearResources>(where);
        ...
        public HttpResponseMessage GetListenSpeakListTest()
        {
            string where = "1=1";
            string data =
                "{\"UserID\":\"1544141752\",\"BookID\":\"291\",\"SecondModuleID\":\"1001\",\"FirstTitleID\":\"286425\",\"IsEnableOss\":1,\"FirstModuleID\":\"10\",\"SecondTitleID\":\"\"}";
            ...
            try
            {
                ...
                for (int i = 0, length = submitData.Achievement.Count; i < length; i++)
                {
                    if (!sign)
                    {
                        ...
                        IList<TB_UserHearResources> resourcesList = hearResourcesBLL.GetUserHearResourcesList(where);
                        if (resourcesList != null && resourcesList.Count > 0)
                        {
                    ...
                    TB_UserHearResources resourcesInfo = new TB_UserHearResources();
        ...
        public HttpResponseMessage GetBookResources([FromBody] KingRequest request)
        {
            ...
            {
                 sql = "SELECT ResourceUrl FROM [FZ_HearResources].[dbo].[TB_BookResource] WHERE BookID='" + submitData.BookID + "'";
            }
            else
            {
                sql = "SELECT ResourceUrl FROM [FZ_HearResources].[dbo].[TB_BookResource_YX] WHERE BookID='" + submitData.BookID + "'";
            }
    ...
    public class ModuleInfo
    {
        ...
        public IList<ListenSpeakInfo> Achievement { get; set; }
    }

    public class ListenSpeakInfo
    {
    ...
    public class SecondModule
    {
        ...
        public List<SubModuleDetails> History { get; set; }
    }
    ...
    public class ListSubModuleCompare : IEqualityComparer<ListSubModules>
    {
        // 摘要: 
        //     确定指定的对象是否相等。
        //
        ...
        public bool Equals(ListSubModules x, ListSubModules y)
        {
        ...
        public int GetHashCode(ListSubModules obj)
        {
            return 0;
        }
    }
