<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOpen.aspx.cs" Inherits="Kingsun.SynchronousStudy.Web.UserManagement.UserOpen" %>
            ...
            <asp:Repeater ID="rpStatistics" runat="server" OnItemCommand="rpStatistics_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lbSerach" runat="server" Text="删除" CommandName="Serach" CommandArgument='<%#Eval("OpenID") %>'></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
