...
function FileProgress(file, targetID) {
    ...
    if (!this.fileProgressWrapper) {
        ...
        progressText.appendChild(document.createTextNode("标题：" + file.name));
        ...
        var progressIndex = document.createElement("div");
        progressIndex.className = "progressIndex";
        progressIndex.innerHTML = file.index + 1;


        this.fileProgressElement.appendChild(progressCancel);
        this.fileProgressElement.appendChild(progressIndex);
...
FileProgress.prototype.disappear = function () {
    ...
    if (this.height > 0 || this.opacity > 0) {
        ...
        var divlist = $(".progressBarComplete");
        var divlist2 = $(".progressBarInProgress");
        if ((!divlist || divlist.length == 0) && (!divlist2 || divlist2.length == 0)) {
