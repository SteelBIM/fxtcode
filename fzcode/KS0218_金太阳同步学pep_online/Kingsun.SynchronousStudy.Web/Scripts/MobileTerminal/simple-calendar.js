        ...
        value: function updateEvent() {
            ...
            daysElement.forEach(function (v, i) {
                ...
                v.onclick = function () {
                    ...
                    var days = $(".sc-selected .day").html();
                    var months = $(".sc-select-month").val();
                    var years = $(".sc-select-year").val();
                    var d = years + "-" + months + "-" + days;
                    $(".date").html(d);
                    window.location.href = "../LearningReportInfo/LR_ClassList.aspx?UserID=" + $("#divUserID").html() + "&EditionID=" + $("#divEditionID").html() + "&ClassID=" + $("#span").attr("classid") + "&Time=" + d;
                };
            });
