...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		dateFormat: 'yyyy-mm-dd', // date formatting. Available formats: http://docs.jquery.com/UI/Datepicker/%24.datepicker.formatDate
