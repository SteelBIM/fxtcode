...
<body onload="refurFrame('应用管理>>课程列表>>版本更新列表')">
    ...
    <div>
        ...
        <div>
            <table id="tbCourseVersion">
                <thead>
                    <tr>
                        <th data-options="field:'Version',width:100">
                            课程版本号
                        </th>
                        <th data-options="field:'Description',width:150">
                            版本描述
                        </th>
                        <th data-options="field:'ModuleID',width:150,formatter:GetModuleName">
                            模块名称
                        </th>
                        <th data-options="field:'Disable',width:50,formatter:CourseVersionStatus">
                            状态
                        </th>
                        <th data-options="field:'DownloadTimes',width:50">
                            下载次数
                        </th>
                        <th data-options="field:'CreateDateTime',width:100,formatter:CourseVersionDate">
                            发布时间
                        </th>
                        <th data-options="field:'Creator',width:100">
                            上传人
                        </th>
                        <th data-options="field:'ID',width:200,formatter:CourseVersionOpetate">
                            操作
                        </th>
                    </tr>
                </thead>
    ...
    <div id="divAdd">
        ...
        <table cellpadding="3" style="margin: 20px;">
            ...
            <tr>
                <td style="text-align: right;">
                    课程版本<span style="color: Red">*</span>：
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <textarea id="txtUpdateDescription" style="width: 350px; height: 150px; max-width: 450px;
            ...
            <tr>
                ...
                <td>
                    <input type="text" onkeyup="value=value.replace(/[^\d\w]/g,'')" style="width: 300px;
