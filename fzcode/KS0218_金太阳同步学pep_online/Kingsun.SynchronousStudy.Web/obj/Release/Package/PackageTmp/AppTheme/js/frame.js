...
$(function () {
    ...
    $(".menuUl li a.collapsed").click(function () {
        ...
        $(this).parent().find('li').show().end().siblings().find('li').hide();
    });

    $(".menuUl li ul li a.collapsed").click(function () {
        $(this).parent().parent().parent().find('li').show().end().siblings().find('li').hide();
    });
