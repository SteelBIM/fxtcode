<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportExcel.aspx.cs" Inherits="Kingsun.SynchronousStudy.Web.CourseManagement.ImportExcel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnImport" runat="server" Text="导入目录页码" OnClick="btnImport_Click" />
         <asp:Button ID="btnYXImport" runat="server" Text="导入优学目录页码" OnClick="btnYXImport_Click" />
        <div>
