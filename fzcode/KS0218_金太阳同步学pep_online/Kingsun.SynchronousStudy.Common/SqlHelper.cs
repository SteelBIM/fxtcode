...
namespace Kingsun.SynchronousStudy.Common
{
    ...
    public sealed class SqlHelper
    {
        ...
        private static string _examconnectionString = string.Empty;
        private static string _interestdubbinggamenectionString = string.Empty;
        private static string _rjtbxconnectionString = string.Empty;
        public static string GetConnectionString(string tablename)
        {
            ...
            string FZ_InterestDubbing = "TB_UserVideoDetails|TB_UserVideoDialogue|TB_VideoDetails|TB_VideoDialogue|TB_UserVideoDetails_YX|TB_UserVideoDialogue_YX|TB_VideoDetails|TB_VideoDialogue_YX";
        ...
        public static string ConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
                {
                    ...
                    _connectionString =
                        System.Configuration.ConfigurationManager.ConnectionStrings["KingsunConnectionStr"]
                            .ConnectionString;
        ...
        /// 同步学链接字符串KingsunConnectionStr
        /// </summary>
        public static string KingsunBaseDbConnectionStr
        {
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
                {
                    string k = "KS0210KINGSUNSOFT2008123456789";
                    _connectionString =
                        System.Configuration.ConfigurationManager.ConnectionStrings["KingsunBaseDBConnectionStr"]
                            .ConnectionString;
                    //_connectionString = xxtea.Decrypt(_connectionString, k);
                }
                return _connectionString;
        ...
        /// <summary>
        /// 趣配音报名链接字符串InterestDubbingGameConnectionStr
        /// </summary>
        ...
        public static string ExamConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_examconnectionString))
                {
                    string k = "KS0210KINGSUNSOFT2008123456789";
                    _examconnectionString =
                        System.Configuration.ConfigurationManager.ConnectionStrings["KingsunExamPaperConnectionStr"]
                            .ConnectionString;
                    //_connectionString = xxtea.Decrypt(_connectionString, k);
                }
                return _examconnectionString;
            }
        }

        /// <summary>
        /// 人教优学链接字符串KingsunConnectionStr
        /// </summary>
        public static string RJTBXConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_rjtbxconnectionString))
                {
                    string k = "KS0210KINGSUNSOFT2008123456789";
                    _rjtbxconnectionString =
                        System.Configuration.ConfigurationManager.ConnectionStrings["RJTBX"]
                            .ConnectionString;
                    //_connectionString = xxtea.Decrypt(_connectionString, k);
                }
                return _rjtbxconnectionString;
            }
        }
        ...
        private static void AssignParameterValues(SqlParameter[] commandParameters, object[] parameterValues)
        {
            ...
            {
                // 如果当前数据来自于IDbDataParameter, 则用它的属性值赋值
            ...
            CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            if (transaction != null)
            {
                ...
                {
                    throw new ArgumentException("事务已经被回滚或者提交，请提供一个打开的事务。", "transaction");
                }
        ...
        /// <param name="commandText">存储过程名称或SQL语句</param>
        /// <returns>返回命令影响的行数</returns>
        public static int ExecuteNonQueryTimeOut(string connectionString, CommandType commandType, string commandText)
        {
        ...
        /// <summary>
        /// 同时执行多次增、删、改（无参数SQL语句）
        /// </summary>
        /// <param name="list">SQL语句集合</param>
        /// <returns>是否成功（true、false）</returns>
        public static bool ExecuteNonQueryTransaction(List<string> list)
        {
            ...
            using (SqlDataAdapter dataAdapter = new SqlDataAdapter(command))
            {
                ...
                if (tableNames != null && tableNames.Length > 0)
                {
                    ...
                    for (int index = 0; index < tableNames.Length; index++)
                    {
                        ...
                        {
                            throw new ArgumentException("参数tableNames必须包含一个表格列表, 有一个值被设置为了NULL或空字符串。", "tableNames");
                        }
