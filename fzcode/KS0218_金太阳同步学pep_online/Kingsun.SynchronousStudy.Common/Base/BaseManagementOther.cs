...
{   /// <summary>
    /// 仅供IBS写入BaseDB总库
    /// </summary>
    public class BaseManagementOther
    {
        ...
        public static string ConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
                {
                    ...
                    _connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["KingsunBaseDBConnectionStr"].ConnectionString;
        ...
        {
            string FZ_HearResources = "TB_BookResource|TB_HearResources|TB_UserHearResources";
            string FZ_InterestDubbing = "TB_UserVideoDetails|TB_UserVideoDialogue|TB_VideoDetails|TB_VideoDialogue";
        ...
        {
            IDBManage dbManage = DBFactory.CreateDBManage(ConnectionString);
