...
namespace Kingsun.SynchronousStudy.Common
{
    public class XmlHelper
    {
        ...
        private XmlDocument XMLLoad()
        {
            ...
            try
            {
                string filename = XMLFile;// AppDomain.CurrentDomain.BaseDirectory.ToString() + XMLFile;
        ...
        /// </summary>
        public static List<T> Read<T>(string xmlPath, string parentNode)
        {
        ...
        /// 使用示列:
        /// XmlHelper.Read("/Node", "")
        /// XmlHelper.Read("/Node/Element[@Attribute='Name']")
        ...
        /// <summary>
        /// 将DataTable的内容写入到XML文件中(存在就删除，反之添加)
        /// </summary>
        /// <param name="dt">数据源</param>
        /// <param name="address">XML文件地址</param>
        /// <param name="ParentNode">父节点</param>
        /// <param name="ChildNode">子节点</param>
        public static bool WriteToXml(DataTable dt, string address, string ParentNode, string ChildNode)
        {
            try
            {
                ...
                //writer.WriteComment(ParentNode+":" + dt.TableName);
                writer.WriteStartElement(ParentNode); //DataTable开始
                //writer.WriteAttributeString("TableName", "APPManagement");
                ...
                //writer.WriteStartElement("APPManagement", ""); //ColumnName开始
