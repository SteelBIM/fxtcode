...
{
    public class YXHearLearningReportDAL
    {
                    ...
                    try
                    {
                        foreach (var stu in userClassList.ClassStuList)
                        {
                            ...
                            if (!string.IsNullOrEmpty(value))
                            {
                                ...
                                var rdsBookDetail = study.detail.FirstOrDefault(i => i.BookID == bookId.ToInt() && i.FirstTitleID == item.FirstTitleID && i.SecondTitleID == item.SecondTitleID && i.FirstModularID == item.FirstModularID && i.SecondModularID == item.SecondModularID);
                ...
                foreach (var item in userClass.ClassStuList)
                {
                    ...
                    if (module != null)
                    {
                        ...
                        if (rdsBookDetail != null)
                        {
                            ...
                            uvi.LinkURL = LinkUrl + "?UserID=" + item.StuID + "&BookID=" + rdsBookDetail.BookID + "&FirstTitleID=" + rdsBookDetail.VideoNumber + "&SecondTitleID=" + rdsBookDetail.SecondTitleID + "&FirstModularID=" + rdsBookDetail.FirstModularID + "&FirstModularID=" + rdsBookDetail.SecondModularID + "&AppID=" + AppID;
                        }
                        else
                        {
