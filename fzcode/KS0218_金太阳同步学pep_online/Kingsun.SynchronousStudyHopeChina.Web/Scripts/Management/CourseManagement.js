...
Kingsun.AppLibrary.CourseManagement = function () {
    ...
    this.UpdateCourse = function (CourseID, Version, UpdateUrl, Description, UpdateMD5, FirstPageNum, TryUpdate, CompleteURL, CompleteMD5, Event) {
        var data = {
            CourseID: CourseID,
            Version: Version,
            UpdateURL: UpdateUrl,
    ...
    this.EditCourseVersion = function (ID, UpdateUrl, Description, UpdateMD5, FirstPageNum, TryUpdate, CompleteURL, CompleteMD5, Event) {
        var data = {
            ID: ID,
            UpdateURL: UpdateUrl,
            Description: Description,
