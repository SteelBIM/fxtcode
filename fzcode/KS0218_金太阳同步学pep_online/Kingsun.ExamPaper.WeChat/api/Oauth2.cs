...
namespace Kingsun.ExamPaper.Wechat.api
{
    ...
    public class Oauth2
    {
        ...
        {
            return string.Format("https://open.weixin.qq.com/connect/oauth2/authorize?appid={0}&redirect_uri={1}&response_type=code&scope={2}&state=STATE#wechat_redirect", Appid, HttpUtility.UrlEncode(redirect_uri), scope);
        }
