<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Members.aspx.cs" Inherits="Kingsun.ExamPaper.WeChat.ClassManagement.Members" %>
...
<head runat="server">
    ...
    <script src="../Js/OfficialAccounts/Members.js"></script>
...
<body>
    <form id="form1" runat="server">
        <div class="main main2">
            <div class="Html5">
                <p class="p2" >班级成员<span id="studentNum">(<em>3</em>人)</span></p>
                <ul id="studentList">
                </ul>
            </div>
        </div>
        <div class="footer">
            <a class="invite1" id="InviteStu">邀请学生</a>
        </div>
        <!--弹框-->
        <div class="box">
            <div class="wai">
