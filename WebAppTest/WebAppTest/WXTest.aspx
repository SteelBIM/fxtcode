<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WXTest.aspx.cs" Inherits="WebAppTest.WXTest" %>
...
&nbsp;&nbsp;
       ...
       微信OpenID: 
        <asp:DropDownList ID="DropDownList3" runat="server">
            ...
            <asp:ListItem Value="ocjayjoMDXZYjQkVG6y-H0gDEIz8">银行客户经理--朱焕</asp:ListItem>
            ...
            <asp:ListItem Value="oSRayji3ZfTym9Px42pg2BJwmtaM">估价师</asp:ListItem>
        </asp:DropDownList>
&nbsp;
评估机构: 
