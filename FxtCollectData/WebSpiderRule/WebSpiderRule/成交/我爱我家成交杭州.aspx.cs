...
{
    public partial class 我爱我家成交杭州 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            HttpWebRequest request2 = (HttpWebRequest)WebRequest.Create("http://www.szfcweb.com/szfcweb/(S(2pd31fill0cgmn55vlnvzzno))/DataSerach/SaleInfoProListIndex.aspx");
            request2.Method = "GET";
