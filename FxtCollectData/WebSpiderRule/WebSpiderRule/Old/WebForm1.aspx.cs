...
namespace test20160519
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            content = "[{\"desc\":\"津塘路与利津路交汇\",\"keyword\":\"美爱家园\",\"region\":\"东丽\",\"val\":\"美爱家园\"},{\"desc\":\"金钟河大街573号\",\"keyword\":\"爱家星河国际\",\"region\":\"河北\",\"val\":\"爱家星河国际\"}]";
            System.Text.StringBuilder reslut = new System.Text.StringBuilder();
            Regex reg = new Regex("desc\":\"(?<Address>.*?)\".*?region\":\"(?<AreaName>.*?)\".*?val\":\"(?<ProjectName>.*?)\"");
            MatchCollection mcs = reg.Matches(content);
            if (mcs.Count >= 1)
            {

                string ProjectName = mcs[0].Groups["ProjectName"].Value;
                string AreaName = mcs[0].Groups["AreaName"].Value;
                string Address = mcs[0].Groups["Address"].Value.Replace(" ", "");
            }   
