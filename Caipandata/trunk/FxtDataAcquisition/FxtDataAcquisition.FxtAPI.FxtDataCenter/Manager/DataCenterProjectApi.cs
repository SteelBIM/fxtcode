...
namespace FxtDataAcquisition.FxtAPI.FxtDataCenter.Manager
{
    public static class DataCenterProjectApi
    {
        ...
        /// <returns></returns>
        public static IList<Project> GetProjectByLikeName(string key, int cityId, string username, string signname, List<Apps> appList)
        {
            ...
            if (!string.IsNullOrEmpty(result.data))
            {
                ...
                foreach (JToken jt in _jarray)
                {
                    ...
                    proj = _jobject.ToJSONjss().ParseJSONjss<Project>();
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public static int AddProjectPhoto(int projectId, long buildingId, int cityId, int photoTypeCode, string fileName, string photoName, byte[] data, string username, string signname, List<Apps> appList, out string message)
        {
        ...
        /// <param name="appList">当前用户拥有的api集合</param>
        /// <returns></returns>
        public static IList<CAS.Entity.DBEntity.DATProject> GetProject(string key, int cityId, int areaId, int subAreaId, int pageindex, int pagerecords, string username, string signname, List<Apps> appList)
        {
        ...
        public static List<CAS.Entity.DBEntity.DATProject> GetProjectBuildingHouseAll(int cityId, string username, string signname, List<Apps> appList)
        {
        ...
        public static List<CAS.Entity.DBEntity.DATProject> GetProjectBuildingHouse(int cityId, string proujectIds, string username, string signname, List<Apps> appList)
        {
        ...
        public static List<CAS.Entity.DBEntity.DATProject> GetProjectInfo(int cityId, int projectid, string username, string signname, List<Apps> appList)
        {
        ...
        /// <param name="appList"></param>
        /// <returns></returns>
        public static DatProjectTotal GetProjectBuildingHouseTotal(int cityId, int projectid, string username, string signname, List<Apps> appList)
        {
            var para = new { cityid = cityId, projectid = projectid };
