...
namespace FxtDataAcquisition.Framework.Data.EntityFramework
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<Templet> _templetRepository;
        private IGenericRepository<Field> _fieldRepository;
        private IGenericRepository<FieldTemplet> _fieldTempletRepository;
        private IGenericRepository<FieldGroup> _fieldGroupRepository;
        private IGenericRepository<FieldGroupTemplet> _fieldGroupTempletRepository;
        ...
        {
            get { return _templetRepository ?? (_templetRepository = new GenericRepository<Templet>(_dbContext)); }
        }
        public IGenericRepository<Field> FieldRepository
        {
            get { return _fieldRepository ?? (_fieldRepository = new GenericRepository<Field>(_dbContext)); }
        }
        public IGenericRepository<FieldTemplet> FieldTempletRepository
        {
            get { return _fieldTempletRepository ?? (_fieldTempletRepository = new GenericRepository<FieldTemplet>(_dbContext)); }
        }
        public IGenericRepository<FieldGroup> FieldGroupRepository
        {
            get { return _fieldGroupRepository ?? (_fieldGroupRepository = new GenericRepository<FieldGroup>(_dbContext)); }
        }
        public IGenericRepository<FieldGroupTemplet> FieldGroupTempletRepository
        {
            get { return _fieldGroupTempletRepository ?? (_fieldGroupTempletRepository = new GenericRepository<FieldGroupTemplet>(_dbContext)); }
        }
    }
}
