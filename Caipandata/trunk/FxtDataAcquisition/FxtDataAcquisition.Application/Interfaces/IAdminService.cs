...
namespace FxtDataAcquisition.Application.Interfaces
{
    public interface IAdminService
    {
        ...
        IGenericRepository<Templet> TempletRepository { get; }
        IGenericRepository<Field> FieldRepository { get; }
        IGenericRepository<FieldTemplet> FieldTempletRepository { get; }
        IGenericRepository<FieldGroup> FieldGroupRepository { get; }
        IGenericRepository<FieldGroupTemplet> FieldGroupTempletRepository { get; }
        IAllotFlowService AllotFlowService { get; }
        IProjectAllotFlowSurveyService ProjectAllotFlowSurveyService { get; }
        IHouseService HouseService { get; }
        ISysRoleMenuFunctionService FunctionService { get; }
        IPhotoService PhotoService { get; }
        IProjectService ProjectService { get; }
        IBuildingService BuildingService { get; }
        ICityService CityService { get; }
        IUserInfoService UserService { get; }
        ICodeService CodeService { get; }
        ITempletService TempletService { get; }
