...
namespace FxtDataAcquisition.API.Contract.APIInterface
{
    ...
    public interface  IFxtMobileAPI
    {
        ...
        Stream Entrance(string type, string sinfo, string info);//(string type, string name, string date, string code, string parameter);
        [OperationContract]
        [WebInvoke(
        ...
        Stream UpLoadFile(System.IO.Stream stream, string type, string sinfo, string info);//(string type, string name, string date, string code, string parameter);
