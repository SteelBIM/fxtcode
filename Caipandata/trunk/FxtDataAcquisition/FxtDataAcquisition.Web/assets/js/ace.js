...
function (e, a) {
    ...
    e(window).off("hashchange.ajax").on("hashchange.ajax", function (a, i) {
        ...
        if (s && 0 != s.length) {
            s = s.replace(/^(\#\!)?\#/, "");
            var r = !1;
            "function" == typeof n && (r = n(s)), "string" == typeof r && t(r, s, i || !1, re)
        }
    ...
    if (e.fn.ace_scroll) {
        ...
        if (l && c) {
			...
			}, T = k(), j = i.hasClass("h-sidebar"), H = ace.helper.sidebar_scroll = {
    ...
    function t(a) {
        ...
        if ((v = p - (f + r - 50)) > 0) if (u > h - v && n.top - v > c) a.style.top = "auto", a.style.bottom = "-10px", s && (s.style.marginTop = -(h - 50) + "px", o = !0);
        else {
