...
namespace FxtSpider.Common.Models
{
    ...
    public class NewHouse
    {
        ...
        public NewHouse(string _lpm, string _alsj, string _xzq, string _pq, string _ld, string _fh, string _yt, string _mj, string _dj,
            ...
            string _title, string _phone, string _url, string _bz, string _wzly, string _addres, string _jzxs, string _hymj, string _tjg, string _cwsl, string _ptss, string _dxsmj)
        {
            this.lpm = _lpm;
            this.alsj = _alsj;
            this.xzq = _xzq;
