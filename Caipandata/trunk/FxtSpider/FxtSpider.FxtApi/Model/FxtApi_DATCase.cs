...
namespace FxtSpider.FxtApi.Model
{
    public class FxtApi_DATCase
    {
        ...
        public static FxtApi_DATCase ConvertToObj(string json)
        {
            return JsonHelp.ParseJSONjss<FxtApi_DATCase>(json);
        }
        public static List<FxtApi_DATCase> ConvertToObjList(string json)
        {
            return JsonHelp.ParseJSONList<FxtApi_DATCase>(json);
        }
    }
}
