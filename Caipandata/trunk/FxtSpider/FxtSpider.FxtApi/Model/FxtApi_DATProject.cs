...
{
    public class FxtApi_DATProject
    {
        ...
        public static FxtApi_DATProject ConvertToObj(string json)
        {
            return JsonHelp.ParseJSONjss<FxtApi_DATProject>(json);
        }
        public static List<FxtApi_DATProject> ConvertToObjList(string json)
        {
            return JsonHelp.ParseJSONList<FxtApi_DATProject>(json);
        }
    }
}
