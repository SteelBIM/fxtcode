...
namespace FxtSpider.RunSource.置家网
{
    public class NewDataSpider : INewDataRum
    {
        ...
        protected static string 网站名称 = WebsiteManager.置家网;
        protected static int 网站ID = WebsiteManager.置家网_ID;
        ...
        protected static 网站表 WebObj = WebsiteManager.GetWebById(WebsiteManager.置家网_ID);
        #endregion
        ...
        ///// 行政区
        ///// </summary>
        //protected RegexInfo regex_xzq = new RegexInfo("地址：<a[^<>]+>([^<>]+)</a>", "$1");
        ///// <summary>
        ///// 片区
        ///// </summary>
        ...
        ///// 单价
        ///// </summary>
        //protected RegexInfo regex_dj = new RegexInfo(">售价：<span[^<>]*><b>[^<>]*</b>万</span>\\(([^<>]+)元/平米\\)", "$1");
        ///// <summary>
        ///// 结构
        ///// </summary>
        ...
        ///// 总价
        ///// </summary>
        //protected RegexInfo regex_zj = new RegexInfo(">售价：<span[^<>]*><b>([^<>]+)</b>万<", "$1");
        ///// <summary>
        ///// 所在楼层
        ///// </summary>
        //protected RegexInfo regex_szlc = new RegexInfo(">楼层：第([^<>]+)层/总[^<>]+层<", "$1");
        ///// <summary>
        ///// 总楼层
        ///// </summary>
        ...
        ///// 信息(备注)
        ///// </summary>
        //protected RegexInfo regex_title = new RegexInfo("<div class=\"dtl_fl\"><h1>([^<>]+)</h1>", "$1");
        ///// <summary>
        ///// 电话
        ///// </summary>
        //protected RegexInfo regex_phone = new RegexInfo("<div class=\"dtl_mobile\"><b>([^<>]+)</b>", "$1");
        ///// <summary>
        ///// URL
        ///// </summary>
        //protected RegexInfo regex_infUrl = new RegexInfo("<a href=\"([^\"]+)\"[^<>]+class=\"hl_img\"[^<>]*>", "$1");
        ///// <summary>
        ///// 下一页正则
        ///// </summary>
        ...
        ///// 地址
        ///// </summary>
        //protected RegexInfo regex_address = new RegexInfo(">地址：<a[^<>]+>([^<>]+)</a>[^<>]*<font [^<>]*title=\"([^<>]+)\"[^<>]*>[^<>]+</font>", "$1$2");
        ///// <summary>
        ///// 信息的发布时间
        ///// </summary>
        ...
        //protected RegexInfo 总页数正则 = new RegexInfo(">[^<>]+/([^<>]+)<a[^<>]+>下一页</a>", "$1");
        ...
        public void start()
        {
            List<VIEW_网站爬取配置_城市表_网站表> list = SpiderWebConfigManager.获取置家网下所有城市爬取配置();
