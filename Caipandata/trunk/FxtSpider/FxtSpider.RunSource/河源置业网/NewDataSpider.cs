...
namespace FxtSpider.RunSource.河源置业网
{
    public class NewDataSpider : INewDataRum
    {
        ...
        protected static string 网站名称 = WebsiteManager.河源置业网;
        protected static int 网站ID = WebsiteManager.河源置业网_ID;
        ...
        protected static 网站表 WebObj = WebsiteManager.GetWebById(WebsiteManager.河源置业网_ID);
        /// <summary>
        /// 网站用途对应库用途字典
        /// </summary>
        ...
        ///// 行政区
        ///// </summary>
        //protected RegexInfo regex_xzq = new RegexInfo(">区域：([^<>]+)<", "$1");
        ///// <summary>
        ///// 片区
        ///// </summary>
        ...
        ///// 面积
        ///// </summary>
        //protected RegexInfo regex_mj = new RegexInfo("<strong>面积：([^<>]+)平米</strong>", "$1");
        ///// <summary>
        ///// 单价
        ///// </summary>
        //protected RegexInfo regex_dj = new RegexInfo(">单价：<[^<>]+>([^<>]+)元/平方米<", "$1");
        ///// <summary>
        ///// 结构
        ///// </summary>
        ...
        ///// 总价
        ///// </summary>
        //protected RegexInfo regex_zj = new RegexInfo(">售价：<span>([^<>]+)</span>", "$1");
        ///// <summary>
        ///// 所在楼层
        ///// </summary>
        //protected RegexInfo regex_szlc = new RegexInfo(">楼层：第(\\d+)层/共\\d*层<", "$1");
        ///// <summary>
        ///// 总楼层
        ///// </summary>
        //protected RegexInfo regex_zlc = new RegexInfo(">楼层：第\\d*层/共(\\d+)层<", "$1");
        ///// <summary>
        ///// 户型
        ///// </summary>
        ...
        ///// 信息(备注)
        ///// </summary>
        //protected RegexInfo regex_title = new RegexInfo("><[^<>]+class=\"propInfoTitle\"[^<>]*>([^<>]+)<", "$1");
        ///// <summary>
        ///// 电话
        ///// </summary>
        //protected RegexInfo regex_phone = new RegexInfo("<p[^<>]+class=\"phonezj\"[^<>]*>([^<>]+)</[^<>]+>", "$1");
        ///// <summary>
        ///// URL
        ///// </summary>
        //protected RegexInfo regex_infUrl = new RegexInfo("<div class=\"details\"[^<>]*><a[^<>]*href=\"([^\"]+)\"[^<>]*>", "$1");
        ///// <summary>
        ///// 下一页正则
        ///// </summary>
        //protected RegexInfo regex_nextPage = new RegexInfo("<a[^<>]*href=\"([^\"]+)\"[^<>]*>[^<>]*<[^<>]+class=\"nextpage\"[^<>]*>下一页</[^<>]*></a>", "$1");
        ///// <summary>
        ///// 地址
        ///// </summary>
        ...
        ///// 信息的发布时间
        ///// </summary>
        //protected RegexInfo regex_datetime = new RegexInfo(">[^<>]*发布：([^<>]+)更新", "$1");
        ///// <summary>
        ///// 信息的更新时间
        ///// </summary>
        //protected RegexInfo regex_updatetime = new RegexInfo("更新：([^<>]+)前<", "$1");

        ///// <summary>
        ///// 中介公司
        ///// </summary>
        //protected RegexInfo regex_comName = new RegexInfo(">所属公司：([^<>\\-]+)[^<>]*<", "$1");
        ///// <summary>
        ///// 门店地址
        ///// </summary>
        //protected RegexInfo regex_comArea = new RegexInfo(">所属公司：[^<>\\-]+\\-([^<>\\-]+)<", "$1");

        //protected RegexInfo 总页数正则 = new RegexInfo("<[^<>]+id=\"RL_NoPage\"[^<>]*>[^<>]+/([^<>]+)</td>", "$1");
        ...
        public NewDataSpider()
        {
            ...
            purposeDic.Add("普通住宅", "普通住宅");
            purposeDic.Add("别墅", "别墅");
            purposeDic.Add("商铺门店", "商业");
            purposeDic.Add("写字楼", "办公");
            purposeDic.Add("自建房", "");
            purposeDic.Add("厂房仓库", "厂房");
        ...
        public void start()
        {
            List<VIEW_网站爬取配置_城市表_网站表> list = SpiderWebConfigManager.获取河源置业网下所有城市爬取配置();
        ...
        public void SpiderHouse(string hostUrl, string pageListIndexUrl, int rate, int pageCheckRate)
        {
            ...
            try
            {
                ...
                string 根页面分页链接参数 = pageListIndexUrl.Replace("pageno=", "pageno={0}");
                ...
                while (!string.IsNullOrEmpty(根页面下一页链接))
                {
                    ...
                    log.Debug(string.Format("河源置业网SpiderHouse()--获取根页面下一页链接{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", nowPageList, hostUrl, pageListIndexUrl, CityName));
                ...
                log.Debug(string.Format("河源置业网SpiderHouse()--获取根页面下信息吸取完成,{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", 根页面下一页链接, hostUrl, pageListIndexUrl, CityName));

            }
            catch (Exception ex)
            {
                log.Error(string.Format("河源置业网SpiderHouse()异常,hostUrl:{0}, pageListIndexUrl:{1}, cityName{2}", hostUrl, pageListIndexUrl, CityName), ex);
            }
            log.Debug(string.Format("河源置业网SpiderHouse()--获取{0}页面下详细信息Url吸取完成,详细页面url内容正则析取中-,hostUrl:{1}, pageListUrl:{2}", CityName, hostUrl, pageListIndexUrl));
        ...
        public void GetHouseByUrl(string url)
        {
            ...
            try
            {
                ...
                value_datetime = value_datetime.Trim();
                value_updatetime = value_updatetime.Trim();
                //如果所在楼层和总楼层顺序颠倒
                ...
                isNowPageStop = false;//暂不做时间处理一直吸取
                //保存数据
