...
namespace FxtSpider.RunSource.搜狐二手房
{
    public class NewDataSpider : INewDataRum
    {
        ...
        ///// 楼盘名
        ///// </summary>
        //protected RegexInfo regex_lpm = new RegexInfo(">小区：<a [^<>]+>([^<>]+)</a>", "$1");
        ///// <summary>
        ///// 行政区
        ///// </summary>
        //protected RegexInfo regex_xzq = new RegexInfo("地址：<span [^<>]+><a [^<>]+>([^<>]+)</a>", "$1");
        //protected RegexInfo regex_xzq2 = new RegexInfo("地址：<a [^<>]+>([^<>]+)</a>", "$1");
        ///// <summary>
        ///// 片区
        ///// </summary>
        //protected RegexInfo regex_pq = new RegexInfo("地址：<span [^<>]+><a [^<>]+>[^<>]+</a>-<a [^<>]+>([^<>]+)</a>", "$1");
        //protected RegexInfo regex_pq2 = new RegexInfo("地址：<a [^<>]+>[^<>]+</a>-<a [^<>]+>([^<>]+)</a>", "$1");
        ///// <summary>
        ///// 面积
        ///// </summary>
        //protected RegexInfo regex_mj = new RegexInfo(">面积：([^<>]+)平<", "$1");
        ///// <summary>
        ///// 单价
        ///// </summary>
        //protected RegexInfo regex_dj = new RegexInfo(">单价：([^<>]+)元/平<", "$1");
        ///// <summary>
        ///// 结构
        ///// </summary>
        ...
        ///// 用途
        ///// </summary>
        //protected RegexInfo regex_yt = new RegexInfo(">物业(类型|)：([^<>\\(\\)]+)", "$2");
        ///// <summary>
        ///// 总价
        ///// </summary>
        //protected RegexInfo regex_zj = new RegexInfo(">([^<>]+)</span><span[^<>]*>[^<>]*万<", "$1");
        ///// <summary>
        ///// 所在楼层
        ///// </summary>
        //protected RegexInfo regex_szlc = new RegexInfo(">楼层：([^<>]+)/[^<>]+<", "$1");
        ///// <summary>
        ///// 总楼层
        ///// </summary>
        //protected RegexInfo regex_zlc = new RegexInfo(">楼层：[^<>]+/([^<>]+)<", "$1");
        ///// <summary>
        ///// 户型
        ///// </summary>
        ...
        ///// 装修
        ///// </summary>
        //protected RegexInfo regex_zx = new RegexInfo(">装修(情况|)：([^<>]+)<", "$2");
        ///// <summary>
        ///// 建筑年代
        ///// </summary>
        //protected RegexInfo regex_jznd = new RegexInfo(">建造年代：([^<>]+)年<", "$1");
        ///// <summary>
        ///// 信息(备注)
        ///// </summary>
        //protected RegexInfo regex_title = new RegexInfo("<div [^<>]*class=\"clearfix[^\"]*\"[^<>]*><h[^<>]+>([^<>]+)</h[^<>]+>", "$1");
        ///// <summary>
        ///// 电话
        ///// </summary>
        //protected RegexInfo regex_phone = new RegexInfo("class=\"num\"[^<>]*>([^<>]+)<", "$1");
        //protected RegexInfo regex_phone2 = new RegexInfo("电话：<span[^<>]*>([^<>]+)<", "$1");        
        ///// <summary>
        ///// URL
        ///// </summary>
        //protected RegexInfo regex_infUrl = new RegexInfo("<a [^<>]*href=\"([^<>]+)\" [^<>]*class=\"link_blank\"[^<>]*></a>", "$1");
        ///// <summary>
        ///// 下一页正则
        ///// </summary>
        //protected RegexInfo regex_nextPage = new RegexInfo("<a [^<>]*href=\"([^<>]+)\"[^<>]*><em></em>下一页</a>", "$1");
        ///// <summary>
        ///// 地址
        ///// </summary>
        //protected RegexInfo regex_address = new RegexInfo(">地址：<span class=\"address mr15\"><a [^<>]+>[^<>]+</a>-<a [^<>]+>[^<>]+</a>([^<>]+)<", "$1");
        //protected RegexInfo regex_address2 = new RegexInfo(">地址：<a [^<>]+>[^<>]+</a>-<a [^<>]+>[^<>]+</a>([^<>]+)<", "$1");        
        ///// <summary>
        ///// 信息的发布时间
        ///// </summary>
        //protected RegexInfo regex_datetime = new RegexInfo(">ID\\:\\d+&nbsp;&nbsp;&nbsp;&nbsp;([^<>]+)</", "$1");

        ///// <summary>
        ///// 中介公司
        ///// </summary>
        //protected RegexInfo regex_comName = new RegexInfo(">所属公司：<a[^<>]+>([^<>]+)<", "$1");
        //protected RegexInfo regex_comName2 = new RegexInfo(">所属公司：([^<>]+)<", "$1");
        ///// <summary>
        ///// 门店地址
        ///// </summary>
        //protected RegexInfo regex_comArea = new RegexInfo(">所在门店：<a[^<>]+>([^<>]+)<", "$1");
        //protected RegexInfo regex_comArea2 = new RegexInfo(">所在门店：([^<>]+)<", "$1");

        //protected RegexInfo 总条数正则 = new RegexInfo("共找到 <span[^<>]*>([^<>]+)</span>[^<>]*套二手房<", "$1");
        //protected RegexInfo 行政区文本正则 = new RegexInfo("<div class=\"area\">((?:(?!</div).)*)</div>", "$1");
        //protected RegexInfo 行政区链接正则 = new RegexInfo("<a [^<>]*href=\"(/[^\"]+/[^\"]+/[^\"]*)\">", "$1");
        ...
        protected static string 网站名称 = WebsiteManager.搜狐二手房;
        protected static int 网站ID = WebsiteManager.搜狐二手房_ID;
        ...
        protected static 网站表 WebObj = WebsiteManager.GetWebById(WebsiteManager.搜狐二手房_ID);
        #endregion
        #region 构造函数
        public NewDataSpider()
        {
            ...
            //regex_comArea.RegexInfoList.Add(regex_comArea2);
        }
        #endregion
        ...
        public void start()
        {
            List<VIEW_网站爬取配置_城市表_网站表> list = SpiderWebConfigManager.获取搜狐二手房下所有城市爬取配置();
        ...
        public void SpiderHouse(string hostUrl, string pageListIndexUrl, int rate, int pageCheckRate)
        {
            ...
            try
            {
                ...
                房型页面正则字典集合.Add("*总条数", 总条数正则);
                log.Debug(string.Format("搜狐二手房SpiderHouse()--获取根页面的总条数,hostUrl:{0}, pageListUrl:{1}, cityName{2}", hostUrl, pageListIndexUrl, CityName));
                Dictionary<string, List<string>> 根页面正则字典集合结果 = SpiderHelp.GetHtmlByRegex(pageListIndexUrl, "gb2312", 根页面正则字典集合, WebObj, CityId);
                int count = 根页面正则字典集合结果["*总条数"].Count < 1 ? 0 : Convert.ToInt32(根页面正则字典集合结果["*总条数"][0]);
                log.Debug(string.Format("搜狐二手房SpiderHouse()--获取根页面的总条数为{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", count.ToString(), hostUrl, pageListIndexUrl, CityName));
                //当前根页面总个数大于最大值
                ...
                if (count > maxCount && 行政区链接List.Count>0)
                {
                    ...
                    foreach (string _url in 行政区链接List)
                    {
                        ...
                        //个数获取
                        log.Debug(string.Format("搜狐二手房SpiderHouse()--获取当前行政区页面的总条数,当前链接{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", nowUrl, hostUrl, pageListIndexUrl, CityName));
                        Dictionary<string, List<string>> 行政区页面正则字典集合结果 = SpiderHelp.GetHtmlByRegex(nowUrl, "gb2312", 行政区页面正则字典集合, WebObj, CityId);
                        int _count = 行政区页面正则字典集合结果["*总条数"].Count < 1 ? 0 : Convert.ToInt32(行政区页面正则字典集合结果["*总条数"][0]);
                        log.Debug(string.Format("搜狐二手房SpiderHouse()--获取当前行政区页面的总条数为{0},当前链接{1},hostUrl:{2}, pageListUrl:{3}, cityName{4}", _count.ToString(), nowUrl, hostUrl, pageListIndexUrl, CityName));
                        ...
                        if (_count > maxCount && 片区链接List.Count>0)
                        {
                            foreach (string _url2 in 片区链接List)
                            {
                                ...
                                //获取个数
                                log.Debug(string.Format("搜狐二手房SpiderHouse()--获取当前片区页面的总条数,当前链接{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", nowUrl2, hostUrl, pageListIndexUrl, CityName));
                                Dictionary<string, List<string>> 片区页面正则字典集合结果 = SpiderHelp.GetHtmlByRegex(nowUrl2, "gb2312", 片区页面正则字典集合, WebObj, CityId);
                                int _count2 = 片区页面正则字典集合结果["*总条数"].Count < 1 ? 0 : Convert.ToInt32(片区页面正则字典集合结果["*总条数"][0]);
                                log.Debug(string.Format("搜狐二手房SpiderHouse()--获取当前片区页面的总条数为{0},当前链接{1},hostUrl:{2}, pageListUrl:{3}, cityName{4}", _count2.ToString(), nowUrl2, hostUrl, pageListIndexUrl, CityName));
            ...
            {
                log.Error(string.Format("搜狐二手房SpiderHouse()异常,hostUrl:{0}, pageListIndexUrl:{1}, cityName{2}", hostUrl, pageListIndexUrl, CityName), ex);
            }
            log.Debug(string.Format("搜狐二手房SpiderHouse()--获取{0}页面下详细信息Url吸取完成,详细页面url内容正则析取中-,hostUrl:{1}, pageListUrl:{2}", CityName, hostUrl, pageListIndexUrl));
        ...
        public void GetHouseByUrl(string url)
        {
            try
            {
                ...
                string value_phone = dicRegexInfo_List["regex_phone"].Count < 1 ? "" : dicRegexInfo_List["regex_phone"][0].Replace("-", "");
                string value_address = dicRegexInfo_List["regex_address"].Count < 1 ? "" : dicRegexInfo_List["regex_address"][0].Replace("&nbsp;","");
        ...
        public void SpiderPage(object param)
        {
            ...
            while (!string.IsNullOrEmpty(页面下一页链接))
            {
                ...
                log.Debug(string.Format("搜狐二手房SpiderHouse()--获取根页面下一页链接{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", nowPageList, hostUrl, pageListIndexUrl, CityName));
            ...
            log.Debug(string.Format("搜狐二手房SpiderHouse()--获取{0}页面下信息吸取完成,{1},hostUrl:{2}, pageListUrl:{3}, cityName{4}", pageRemark, 页面下一页链接, hostUrl, pageListIndexUrl, CityName));
        }
        /// <summary>
        /// 发布获取类型页面下案例线程
        /// </summary>
