...
namespace FxtSpider.RunSource.搜房网
{
    public class NewDataSpider : INewDataRum
    {
        ...
        public virtual void SpiderHouse(string hostUrl, string pageListIndexUrl, int rate, int pageCheckRate)
        {
            ...
            #region(出售房源_页面需要爬取的各字段正则)
            regex_lpm = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_lpm", 网站名称, number: RegexNumber);
            regex_xzq = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_xzq", 网站名称, number: RegexNumber);
            regex_pq = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_pq", 网站名称, number: RegexNumber);
            regex_yt = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_yt", 网站名称, number: RegexNumber);
            regex_mj = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_mj", 网站名称, number: RegexNumber);
            regex_dj = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_dj", 网站名称, number: RegexNumber);
            regex_jg = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_jg", 网站名称, number: RegexNumber);
            regex_zj = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_zj", 网站名称, number: RegexNumber);
            regex_szlc = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_szlc", 网站名称, number: RegexNumber);
            regex_zlc = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_zlc", 网站名称, number: RegexNumber);
            regex_hx = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_hx", 网站名称, number: RegexNumber);
            regex_cx = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_cx", 网站名称, number: RegexNumber);
            regex_zx = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_zx", 网站名称, number: RegexNumber);
            regex_jznd = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_jznd", 网站名称, number: RegexNumber);
            regex_title = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_title", 网站名称, number: RegexNumber);
            regex_phone = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_phone", 网站名称, number: RegexNumber);
            regex_infUrl = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_infUrl", 网站名称, number: RegexNumber);
            regex_nextPage = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_nextPage", 网站名称, number: RegexNumber);
            regex_jzxs = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_jzxs", 网站名称, number: RegexNumber);
            regex_cqxz = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_cqxz", 网站名称, number: RegexNumber);
            regex_ptss = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_ptss", 网站名称, number: RegexNumber);
            regex_address = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_address", 网站名称, number: RegexNumber);
            regex_datetime = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_datetime", 网站名称, number: RegexNumber);
            regex_updatetime = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_updatetime", 网站名称, number: RegexNumber);
            regex_hymj = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_hymj", 网站名称, number: RegexNumber);
            regex_tjg = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_tjg", 网站名称, number: RegexNumber);
            regex_cwsl = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_cwsl", 网站名称, number: RegexNumber);
            regex_dxsmj = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_dxsmj", 网站名称, number: RegexNumber);
            regex_comName = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_comName", 网站名称, number: RegexNumber);
            regex_comArea = SpiderRegexInfoHelp.GetRegexInfoByXmlName("regex_comArea", 网站名称, number: RegexNumber);
            总条数正则 = SpiderRegexInfoHelp.GetRegexInfoByXmlName("总条数正则", 网站名称, number: RegexNumber);
            行政区文本正则 = SpiderRegexInfoHelp.GetRegexInfoByXmlName("行政区文本正则", 网站名称, number: RegexNumber);
            行政区链接正则 = SpiderRegexInfoHelp.GetRegexInfoByXmlName("行政区链接正则", 网站名称, number: RegexNumber);
            片区文本正则 = SpiderRegexInfoHelp.GetRegexInfoByXmlName("片区文本正则", 网站名称, number: RegexNumber);
            片区链接正则 = SpiderRegexInfoHelp.GetRegexInfoByXmlName("片区链接正则", 网站名称, number: RegexNumber);
            #endregion
            ...
            try
            {
                SysData_用途 ytObj = 用途Manager.GetById(Convert.ToInt32(BasePurposeCode));
                主用途 = "";
                if (ytObj != null)
                {
                    主用途 = ytObj.用途;
                }
                SysData_案例类型 caseTypeObj = 案例类型Manager.GetById(Convert.ToInt32(BaseCaseTypeCode));
                主案例类型 = "";
                if (caseTypeObj != null)
                {
                    主案例类型 = caseTypeObj.案例类型;
                }
                    ...
                    foreach (string _url in 行政区链接List)
                    {
                        ...
                        if (_count > maxCount && 片区链接List.Count>0)
                        {
                            foreach (string _url2 in 片区链接List)
                            {
                                ...
                                片区页面分页链接参数 = nowUrl2.Replace("h316-j3100-w31", "h316-i3{0}-j3100-w31");
                                片区页面分页链接参数 = nowUrl2.Replace("h316-j3100-i31", "h316-j3100-i3{0}");
        ...
        public void GetHouseByUrl(string url)
        {
            try
            {
                //url = "http://office.zz.fang.com/shou/3_152630708.html";
                //设置各字段规则(正则)
                ...
                //将数据添加到字典 
                NewHouse newHouse = new NewHouse(value_lpm, GetCaseDate(value_datetime, value_updatetime), value_xzq, value_pq, "", "", string.IsNullOrEmpty(主用途) ? "" : 主用途, value_mj, value_dj,
                                string.IsNullOrEmpty(主案例类型) ? "" : 主案例类型, value_jg, "", value_zj, value_szlc, value_zlc, value_hx, value_cx, value_zx, value_jznd,
