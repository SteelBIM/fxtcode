...
namespace FxtSpider.RunSource.中国房产超市
{
    public class NewDataSpider : INewDataRum
    {
        ...
        protected static string 网站名称 = WebsiteManager.中国房产超市;
        protected static int 网站ID = WebsiteManager.中国房产超市_ID;
        ...
        protected static 网站表 WebObj = WebsiteManager.GetWebById(WebsiteManager.中国房产超市_ID);
        #endregion
        #region(出售房源_页面需要爬取的各字段正则)
        ///// <summary>
        ///// 楼盘名
        ///// </summary>
        //protected RegexInfo regex_lpm = new RegexInfo("小区名称：</span>(<a[^<>]+>([^<>]+)|([^<>]+))<", "$2$3");
        ///// <summary>
        ///// 行政区
        ///// </summary>
        //protected RegexInfo regex_xzq = new RegexInfo(">您的位置：[^<>]+><a[^<>]+>出售房源</a>><a [^<>]+>([^<>]+)二手房<", "$1");
        ///// <summary>
        ///// 片区
        ///// </summary>
        ...
        ///// 面积
        ///// </summary>
        //protected RegexInfo regex_mj = new RegexInfo("面积：</dt><dd>([^<>]+)m\\&sup2\\;<", "$1");
        ///// <summary>
        ///// 单价
        ///// </summary>
        //protected RegexInfo regex_dj = new RegexInfo("单价：</[^<>]+><[^<>]+><[^<>]+>([^<>]+)元", "$1");
        ///// <summary>
        ///// 结构
        ///// </summary>
        ...
        ///// 用途
        ///// </summary>
        //protected RegexInfo regex_yt = new RegexInfo(">楼型用途：</[^<>]+><[^<>]+>[^<>]+/([^<>]+)<", "$1");
        ///// <summary>
        ///// 总价
        ///// </summary>
        ...
        ///// 所在楼层
        ///// </summary>
        //protected RegexInfo regex_szlc = new RegexInfo(">所在楼层：</[^<>]+><[^<>]+>[^<>]*[^\\d]*(\\d+)层\\([^<>]+<", "$1");
        ///// <summary>
        ///// 总楼层
        ///// </summary>
        //protected RegexInfo regex_zlc = new RegexInfo(">所在楼层：</[^<>]+><[^<>]+>[^<>]+\\(共([^<>]+)层\\)<", "$1");
        ///// <summary>
        ///// 户型
        ///// </summary>
        ...
        ///// 信息(备注)
        ///// </summary>
        //protected RegexInfo regex_title = new RegexInfo("<h1 class=\"[^\"]+\"><span class=\"[^\"]+\">\\[(<a [^<>]+>[^<>]*</a>|[^<>]*)\\]</span>([^<>]+)</h1>", "$2");
        ///// <summary>
        ///// 电话
        ///// </summary>
        //protected RegexInfo regex_phone = new RegexInfo("<div class=\"tel[^\"]*\">([^<>]+)<", "$1");
        ///// <summary>
        ///// URL
        ///// </summary>
        //protected RegexInfo regex_infUrl = new RegexInfo("td><a href=\"([^\"]+)\"[^<>]*><img [^<>]*class=\"resizeleft\"[^<>]*", "$1");
        ///// <summary>
        ///// 下一页正则
        ///// </summary>
        ...
        ///// 地址
        ///// </summary>
        //protected RegexInfo regex_address = new RegexInfo("小区地址：</span>([^<>]+)<", "$1");
        ///// <summary>
        ///// 信息的发布时间
        ///// </summary>
        //protected RegexInfo regex_datetime = new RegexInfo("span[^<>]*>更新时间：([^<>]+)<", "$1");
        ///// <summary>
        ///// 中介公司
        ///// </summary>
        //protected RegexInfo regex_comName = new RegexInfo(">所属：<a [^<>]+>([^<>]+)</a>", "$1");
        ///// <summary>
        ///// 门店地址
        ///// </summary>
        //protected RegexInfo regex_comArea = new RegexInfo("", "$1");

        //protected RegexInfo 总页数正则 = new RegexInfo(">下一页</a><div[^<>]*><span[^<>]*>[^<>]*</span>/([^<>]+)<", "$1");
        ...
        public void start()
        {
            List<VIEW_网站爬取配置_城市表_网站表> list = SpiderWebConfigManager.获取中国房产超市下所有城市爬取配置();
        ...
        public void SpiderHouse(string hostUrl, string pageListIndexUrl, int rate, int pageCheckRate)
        {
            ...
            try
            {
                ...
                string 根页面分页链接参数 = pageListIndexUrl.TrimEnd('/') + "/sale/search/p{0}.html";
                string 根页面下一页链接 = pageListIndexUrl;
                int 当前总页数 = pageCount;
                int 当前页码 = 1;

                log.Debug(string.Format("中国房产超市SpiderHouse()--获取总页数{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", pageCount, hostUrl, pageListIndexUrl, CityName));
                while (!string.IsNullOrEmpty(根页面下一页链接))
                {
                    ...
                    log.Debug(string.Format("中国房产超市SpiderHouse()--获取根页面下一页链接{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", nowPageList, hostUrl, pageListIndexUrl, CityName));
                ...
                log.Debug(string.Format("中国房产超市SpiderHouse()--获取根页面下信息吸取完成,{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", 根页面下一页链接, hostUrl, pageListIndexUrl, CityName));

            }
            catch (Exception ex)
            {
                log.Error(string.Format("中国房产超市SpiderHouse()异常,hostUrl:{0}, pageListIndexUrl:{1}, cityName{2}", hostUrl, pageListIndexUrl, CityName), ex);
            }
            log.Debug(string.Format("中国房产超市SpiderHouse()--获取{0}页面下详细信息Url吸取完成,详细页面url内容正则析取中-,hostUrl:{1}, pageListUrl:{2}", CityName, hostUrl, pageListIndexUrl));
