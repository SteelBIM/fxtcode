...
namespace FxtSpider.RunSource.住在九江
{
    ...
    {   
        ...
        ///// 楼盘名
        ///// </summary>
        //protected RegexInfo regex_lpm = new RegexInfo("", "$1");
        ///// <summary>
        ///// 行政区
        ///// </summary>
        //protected RegexInfo regex_xzq = new RegexInfo(">所在区域：<a [^<>]*>([^<>]*)</a>", "$1");
        ///// <summary>
        ///// 片区
        ///// </summary>
        ...
        ///// 面积
        ///// </summary>
        //protected RegexInfo regex_mj = new RegexInfo(">面积：([\\.\\d]+)平米<", "$1");
        ///// <summary>
        ///// 单价
        ///// </summary>
        //protected RegexInfo regex_dj = new RegexInfo(">([^<>]+)</span>元/平米", "$1");
        ///// <summary>
        ///// 结构
        ///// </summary>
        ...
        ///// 用途
        ///// </summary>
        //protected RegexInfo regex_yt = new RegexInfo(">房屋类型：([^<>]*)<", "$1");
        ///// <summary>
        ///// 总价
        ///// </summary>
        //protected RegexInfo regex_zj = new RegexInfo(">总价：<[^<>]+>([^<>]+)</[^<>]+> 万元", "$1");
        ///// <summary>
        ///// 所在楼层
        ///// </summary>
        //protected RegexInfo regex_szlc = new RegexInfo("层：(\\d+)楼/共\\d+楼<", "$1");
        ///// <summary>
        ///// 总楼层
        ///// </summary>
        //protected RegexInfo regex_zlc = new RegexInfo("层：\\d+楼/共(\\d+)楼<", "$1");
        ///// <summary>
        ///// 户型
        ///// </summary>
        //protected RegexInfo regex_hx = new RegexInfo(">房屋户型：([^<>]+)<", "$1");     
        ///// <summary>
        ///// 朝向
        ///// </summary>
        //protected RegexInfo regex_cx = new RegexInfo(">朝(?:(?!向).)*向：([^<>]+)<", "$1");
        ///// <summary>
        ///// 装修
        ///// </summary>
        //protected RegexInfo regex_zx = new RegexInfo(">装修情况：([^<>]+)<", "$1");
        ///// <summary>
        ///// 建筑年代
        ///// </summary>
        //protected RegexInfo regex_jznd = new RegexInfo(">建筑年代：(\\d+)年<", "$1");
        ///// <summary>
        ///// 信息(备注)
        ///// </summary>
        //protected RegexInfo regex_title = new RegexInfo("<div[^<>]*class=\"title\"[^<>]*><span[^<>]*>[^<>]*</span>([^<>]+)</div>", "$1");
        ///// <summary>
        ///// 电话
        ///// </summary>
        //protected RegexInfo regex_phone = new RegexInfo(">联系电话：<span[^<>]*>(\\d*)</span>", "$1");       
        ///// <summary>
        ///// URL
        ///// </summary>
        //protected RegexInfo regex_infUrl = new RegexInfo("<div[^<>]*class=\"details\"[^<>]*><h\\d+><a[^<>]*href=\"([^\"]+)\"[^<>]*target=\"_blank\"[^<>]*>[^<>]*</a>", "$1");
        ///// <summary>
        ///// 下一页正则
        ///// </summary>
        //protected RegexInfo regex_nextPage = new RegexInfo("<a[^<>]*href=\"javascript\\:void\\(0\\)\"[^<>]*class=\"cur\"[^<>]*>[^<>]+</a><a href=\"([^\"]+)\">[^<>]+</a>", "$1");
        ///// <summary>
        ///// 地址
        ///// </summary>
        //protected RegexInfo regex_address = new RegexInfo(">地(?:(?!址).)*址：([^<>]*)<", "$1");
        ///// <summary>
        ///// 信息的发布时间
        ///// </summary>
        //protected RegexInfo regex_datetime = new RegexInfo(">登记时间：([^<>]+)<", "$1");
        ///// <summary>
        ///// 中介公司
        ///// </summary>
        //protected RegexInfo regex_comName = new RegexInfo("<dt[^<>]*class=\"picture\"[^<>]*>(?:(?!<strong>).)*<strong>([^<>]*)</strong></dt>", "$1");
        ///// <summary>
        ///// 门店地址
        ///// </summary>
        //protected RegexInfo regex_comArea = new RegexInfo(">门店地址：([^<>]+)<", "$1");

        //protected RegexInfo 总页数正则 = new RegexInfo("<span>共(\\d+)页[^<>]*条记录</span>", "$1");

        //#region 独有正则
        ///// <summary>
        ///// 字符格式中提取时间正则
        ///// </summary>
        //protected RegexInfo time = new RegexInfo("([^\\s]+) ([^\\s]+) ([^\\s]+) ([^\\s]+) ([^\\s]+) ([^\\s]+)", "$6-{0}-$3 $4");
        ///// <summary>
        ///// 字符格式中提取月份正则
        ///// </summary>
        //protected RegexInfo time2 = new RegexInfo("([^\\s]+) ([^\\s]+) ([^\\s]+) ([^\\s]+) ([^\\s]+) ([^\\s]+)", "$2");
        //#endregion
        #endregion
        ...
        /// 字符格式中提取时间正则
        /// </summary>
        protected RegexInfo time = SpiderRegexInfoHelp.GetRegexInfoByXmlName("time", 网站名称);
        /// <summary>
        /// 字符格式中提取月份正则
        /// </summary>
        protected RegexInfo time2 = SpiderRegexInfoHelp.GetRegexInfoByXmlName("time2", 网站名称);
        #endregion
        #endregion
        ...
        protected static string 网站名称 = WebsiteManager.住在九江;
        protected static int 网站ID = WebsiteManager.住在九江_ID;
        protected static readonly ILog log = LogManager.GetLogger(typeof(NewDataSpider));
        protected static 网站表 WebObj = WebsiteManager.GetWebById(WebsiteManager.住在九江_ID);
        /// <summary>
        /// 网站用途对应库用途字典
        /// </summary>
        ...
        /// 吸取时不包含用途
        /// </summary>
        protected string[] notExistsPurposes = new string[] { "写字楼", "店面房", "厂房", "其他" };
        /// <summary>
        /// 提取月份
        /// </summary>
        protected string[] months = new string[] { "jan,01", "feb,02", "mar,03", "apr,04", "may,05", "jun,06", "jul,07", "aug,08", "sep,09", "oct,10", "nov,11", "dec,12" };
        ...
        public NewDataSpider()
        {
            ...
            purposeDic.Add("公寓", "公寓");
            purposeDic.Add("单身公寓", "公寓");
            purposeDic.Add("民房", "");
            purposeDic.Add("商住房", "");
        }
        #endregion
        ...
        public void start()
        {
            List<VIEW_网站爬取配置_城市表_网站表> list = SpiderWebConfigManager.获取住在九江下所有城市爬取配置();
        ...
        public void SpiderHouse(string hostUrl, string pageListIndexUrl, int rate, int pageCheckRate)
        {
            ...
            //stest.Append(SpiderRegexInfoHelp.GetRegexInfoXmlByObj(time, "time", "字符格式中提取时间正则(独有正则)")); ;
            //stest.Append(SpiderRegexInfoHelp.GetRegexInfoXmlByObj(time2, "time2", "字符格式中提取月份正则(独有正则)")); ;
            ...
            try
            {
                ...
                string 根页面分页链接参数 = pageListIndexUrl.Replace("pageNo=1", "pageNo={0}");
                ...
                while (!string.IsNullOrEmpty(根页面下一页链接))
                {
                    ...
                    log.Debug(string.Format("住在九江SpiderHouse()--获取根页面下一页链接{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", nowPageList, hostUrl, pageListIndexUrl, CityName));
                ...
                log.Debug(string.Format("住在九江SpiderHouse()--获取根页面下信息吸取完成,{0},hostUrl:{1}, pageListUrl:{2}, cityName{3}", 根页面下一页链接, hostUrl, pageListIndexUrl, CityName));

            }
            catch (Exception ex)
            {
                log.Error(string.Format("住在九江SpiderHouse()异常,hostUrl:{0}, pageListIndexUrl:{1}, cityName{2}", hostUrl, pageListIndexUrl, CityName), ex);
            }
            log.Debug(string.Format("住在九江SpiderHouse()--获取{0}页面下详细信息Url吸取完成,详细页面url内容正则析取中-,hostUrl:{1}, pageListUrl:{2}", CityName, hostUrl, pageListIndexUrl));
        ...
        public string CheckPurpose(string value_yt)
        {
            ...
            if (notExistsPurposes.Contains(value_yt))
            {
                return "0";
            }
