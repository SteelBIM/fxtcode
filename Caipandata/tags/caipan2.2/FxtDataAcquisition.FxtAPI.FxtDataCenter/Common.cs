...
namespace FxtDataAcquisition.FxtAPI.FxtDataCenter
{
    public static class Common
    {
        ...
        /// <returns></returns>
        public static DataCenterResult PostDataCenter(string userName, string signName, string functionName, object parasObj, List<UserCenter_Apps> appList)
        {
        ...
        /// <returns></returns>
        public static DataCenterResult PostDataCenter(string userName, string signName, string functionName, object parasObj, byte[] data, List<UserCenter_Apps> appList)
        {
            string appPwd = "";
            string appKey = "";
            string apiUrl = "";
