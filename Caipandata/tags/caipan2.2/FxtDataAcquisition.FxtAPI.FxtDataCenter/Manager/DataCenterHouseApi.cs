...
namespace FxtDataAcquisition.FxtAPI.FxtDataCenter.Manager
{
    public static class DataCenterHouseApi
    {
        ...
        /// <returns></returns>
        public static IList<DATHouse> GetHouseByBuildingIdAndFloorNo(int buildingId, int floorNo, int cityId, string username, string signname, List<UserCenter_Apps> appList)
        {
