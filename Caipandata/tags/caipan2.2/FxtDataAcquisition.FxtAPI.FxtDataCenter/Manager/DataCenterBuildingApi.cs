...
namespace FxtDataAcquisition.FxtAPI.FxtDataCenter.Manager
{
    public static class DataCenterBuildingApi
    {
        ...
        /// <returns></returns>
        public static IList<DATBuilding> GetBuildingByProjectId(string key, int cityId, int projectId, string username, string signname, List<UserCenter_Apps> appList)
        {
