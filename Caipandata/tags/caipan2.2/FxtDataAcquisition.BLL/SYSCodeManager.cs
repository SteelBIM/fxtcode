using FxtDataAcquisition.DTODomain.FxtUserCenterDTO;
...
namespace FxtDataAcquisition.BLL
{
    public static class SYSCodeManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static IList<SYSCode> GetStructureCodeList()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static IList<SYSCode> GetFrontCodeList()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static IList<SYSCode> GetHouseTypeCodeList()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static IList<SYSCode> GetSightCodeList()
        {
        ...
        {
            List<SYSCode> list = SYSCodeApi.GetSYSCodeById(2009).Where(m => m.Code > 2009009).ToList();
            return list;
        }
        /// <summary>
        /// 楼栋外墙
