$(function(){
    var showResult=$("#hdResult").val();
    if(showResult=="0")
    {
        $("#errorAlert_notexists").show();
    }
...
function SubmitData()
{
    ...
    var paraJson={departmentId:departmentId,departmentName:encodeURIComponent(departmentName)};
    $("#btnSubmit").val("提交中...");
    $.extendAjax(
                {   
                ...
                function(data)
                {
                    ...
                    if(data!=null)
                    {
                        ...
                        else
                        {
                            ...
                            parent.EditDepartment_Response(data.detail,departmentId,departmentName);
