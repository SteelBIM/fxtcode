...
function GetAllotFlowList(pageIndex) {
    ...
    var paraJson = {
        ...
        , startDate: startDate, endDate: endDate, functionCodes: functionCodes, pageIndex: pageIndex, pageSize: pageSize, isGetCount: isGetCount
    };
    $.extendAjax(
                {
                ...
                function (data) {
                    ...
                    if (data != null) {
                        ...
                        if ($("#hdAllotFlowCount").val() == "") {
                            $("#hdAllotFlowCount").val(data.data.Count);
                        ...
                        $("#allotCountShow").html($("#hdAllotFlowCount").val());
                        var count_data = $("#hdAllotFlowCount").val();
