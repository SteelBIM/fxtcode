...
namespace FxtDataAcquisition.FxtAPI.FxtUserCenter.Manager
{
    public static class UserCenterUserInfoApi
    {
        ...
        /// <returns></returns>
        public static List<UserCenter_UserInfo> GetUserListByCompanyId(int companyId,string[] userNames,string keyWord,int? valid,int pageIndex,int pageSize,out int count, string loginusername, string loginsignname,List<UserCenter_Apps> appList)
        {
            count = 0;
            ...
            List<UserCenter_UserInfo> list = new List<UserCenter_UserInfo>();
            if (!string.IsNullOrEmpty(result.data))
            {
                list = result.data.ParseJSONList<UserCenter_UserInfo>();
            }
        ...
        /// <returns></returns>
        public static int[] GetCompanyProductCityIds(string signname, int productcode, string loginusername, string loginsignname, List<UserCenter_Apps> appList)
        {
            int[] cityIds = null;
        ...
        /// <param name="appList"></param>
        /// <returns></returns>
        public static int[] GetCompanyProductMuduleCityIds(string signname, int productcode, string loginusername, string loginsignname, List<UserCenter_Apps> appList)
        {
            int[] cityIds = null;
            var para = new { signname = signname, productcode = productcode };
