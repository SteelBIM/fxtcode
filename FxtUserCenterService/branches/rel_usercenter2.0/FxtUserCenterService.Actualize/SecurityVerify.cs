                    ...
                    else
                    {
                        ...
                        switch (dateVeify)
                        {
                            ...
                            case 0:
                                ...
                                break;
                            case 1:
                                jsonData = UserBL.GetUserAndAppInfo(null, paramInfo.uinfo.password, StringHelper.TryGetInt(paramInfo.appinfo.systypecode), paramInfo.uinfo.username, paramInfo.appinfo.stype, paramInfo.appinfo.splatype, paramInfo.appinfo.channel);
                                break;
                        }
