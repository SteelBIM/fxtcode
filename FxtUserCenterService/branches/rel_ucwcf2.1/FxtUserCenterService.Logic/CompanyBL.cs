...
namespace FxtUserCenterService.Logic
{
    public class CompanyBL
    {
        ...
        /// <returns></returns>
        public static List<CompanyInfo> GetCompanyList(SearchBase search, string companyname, int companytypecode)
        {
            return CompanyDA.GetCompanyList(search, companyname, companytypecode);
        }
