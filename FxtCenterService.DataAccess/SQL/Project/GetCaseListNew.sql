select
	r,casesum,MaxUnitPrice,MinUnitPrice,convert(numeric(18,0),(case when ctotalbuildingarea > 0 then ctotalprice / ctotalbuildingarea else 0 end)) as cunitprice,AreaId,ProjectId,ProjectName,CaseDate,CaseTypeCode,BuildingArea,UnitPrice,TotalPrice,BuildingTypeCode,PurposeCode,SourceName
from(
	select
