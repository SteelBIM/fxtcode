...
namespace FxtCenterService.Logic
{
    public class DATCaseBL
    {
        ...
        {
            return DATCaseDA.GetDATCaseListByCalculate(search, projectname, minBuildingArea, maxBuildingArea, minFloorNumber, maxFloorNumber, address);
        }
        ...
        {
            return DATCaseDA.GetDATCaseListByCalculateForSpecial(search, projectname, minBuildingArea, maxBuildingArea, minFloorNumber, maxFloorNumber, address);
        }
        ...
        {
            return DATCaseDA.GetSameProjectCasePrice(fxtcompanyid, cityid, projectid, buildingtypecode, buildingenddate, areaid, surveyx, surveyy, startdate, enddate);
        }
