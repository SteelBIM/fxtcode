...
and  (','+cast((select showcompanyid from dbo.privi_company_showdata with(nolock) where Fxtcompanyid=@fxtcompanyid and Cityid = @cityid) as varchar)+',' like '%,' + cast(b.fxtcompanyid as varchar) + ',%')
union 
...
and (','+cast((select showcompanyid from dbo.privi_company_showdata pc with(nolock) where pc.Fxtcompanyid=@fxtcompanyid and pc.Cityid = @cityid) as varchar)+',' like '%,' + cast(fxtcompanyid as varchar) + ',%')
union
