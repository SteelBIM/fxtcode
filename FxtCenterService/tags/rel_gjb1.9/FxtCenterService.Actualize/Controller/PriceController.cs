    ...
    public partial class DataController
    {
        ...
        public static string GetEValueByProjectIdWithCmb(JObject funinfo, UserCheck company)
        {
            ...
            if (ygjunitprice > 0 && pricetype > 0)
            {
                ...
                autoPrice = new AutoPrice() { unitprice = ygjunitprice, pricetype = pricetype, avgpricelist = avgpricelist };
            }
        ...
        public static string GetSameProjectCasePrice(JObject funinfo, UserCheck company)
        {
            ...
            try
            {
                DataSet sameprojectDs = DATCaseBL.GetSameProjectCasePrice(search.FxtCompanyId, search.CityId, projectid, buildingtypecode, buildingenddate, areaid, surveyx, surveyy, startdate, enddate);
        ...
        /// <param name="company"></param>
        /// <returns></returns>
        public static string GetDATQueryHistoryList(JObject funinfo, UserCheck company)
        {
            SearchBase search = DataCenterCommon.InitSearBase(funinfo);
            ...
            var datQueryHistory = DATQueryHistoryBL.GetDATQueryHistoryList(search, username,wxopenid).Select(o => new
            {
                id = o.id,
        ...
        public static string GetMatchingData(JObject funinfo, UserCheck company)
        {
            ...
            DataSet dset = DATQueryHistoryBL.GetMatchingData(cityid,projectname, addresss,
                buildingname, housename, p_projectid, p_buildingid, fxtcompanyid);
