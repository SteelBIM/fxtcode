...
namespace FxtCenterService.Logic
{
    public class DATCaseBL
    {
        ...
        {
            return DATCaseDA.GetCasePrice(search, buildingtypecode, purposecode, casetypecode, casedatefrom, casedateto, buildingareafrom, buildingareato, projectname, isSource);
        }
    }
