...
namespace FxtCenterService.DataAccess
{
    public class DATQueryHistoryDA : Base
    {
        ...
        public static DataSet GetMatchingData(int cityid, string projectname, string addresss, string buildingname, string housename, int p_projectid, int p_buildingid, int fxtcompanyid, int typecode)
        {
            ...
            cmd.Parameters.Add(SqlHelper.GetSqlParameter("@projectname", (projectname == null ? "" : projectname), SqlDbType.NVarChar, 200));
            cmd.Parameters.Add(SqlHelper.GetSqlParameter("@address", (addresss == null ? "" : addresss), SqlDbType.NVarChar, 200));
            cmd.Parameters.Add(SqlHelper.GetSqlParameter("@buildingname", (buildingname == null ? "" : buildingname), SqlDbType.NVarChar, 200));
            cmd.Parameters.Add(SqlHelper.GetSqlParameter("@housename", (housename == null ? "" : housename), SqlDbType.NVarChar, 200));
