...
inner join (
	select CityID,AreaID,ProjectId,ProjectName,FxtCompanyId,StartDate,UsableYear,CubageRate,GreenRate,Wrinkle,Aversion
	...
	union
	select CityID,AreaID,ProjectId,ProjectName,Fxt_CompanyId,StartDate,UsableYear,CubageRate,GreenRate,Wrinkle,Aversion
