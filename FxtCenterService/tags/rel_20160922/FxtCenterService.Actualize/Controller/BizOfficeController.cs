...
namespace FxtCenterService.Actualize
{
    public partial class DataController
    {
        ...
        public static string GetCaseListLand(JObject funinfo, UserCheck company)
        {
            ...
            var list = DatBizOfficeBL.GetCaseListLand(search, landno, minBuildingArea, maxBuildingArea, minUnitPrice, maxUnitPrice, landPurposeDesc, areaid, subareaid, startCaseDate, endCaseDate);
            return list.ToJson();
        }
