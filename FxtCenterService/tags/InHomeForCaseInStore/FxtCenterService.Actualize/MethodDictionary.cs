...
namespace FxtCenterService.Actualize
{
    ...
    public class MethodDictionary
    {
        ...
        private const string projectmatchlist = "projectmatchlist";
        ...
        private const string addprojectcasedate = "addprojectcasedate";//案例入库
