...
namespace FxtCenterService.Logic
{
    public class DatProjectBL
    {
        ...
        /// <returns></returns>
        public static List<Dictionary<string, object>> GetProjectDropDownList_MCAS_SDK(SearchBase search, string strKey, string buildingName, int items, string serialno, int producttypecode, int companyid, int priceorderby = 0)
        {
            List<Dictionary<string, object>> listResult = new List<Dictionary<string, object>>();
