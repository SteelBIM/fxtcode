...
namespace FXT.VQ.DataService.Model
{
    ...
    public class SecurityInfo
    {
        ...
        public string appid
        {
            get
            {
                return ConfigSettings.mDataCenterAppid;
            }
        }
        public string apppwd
        {
            get
            {
                return ConfigSettings.mDataCenterApppwd;
            }
        }
        public string signname
        {
            get
            {
                return ConfigSettings.mDataCenterSignname;
            }
        }
        public string time
        {
        ...
        public string code
        {
            get
            {
                ...
                return GetMd5(string.Join("", _securityArray), ConfigSettings.mDataCenterAppkey).ToLower();
            }
        }
