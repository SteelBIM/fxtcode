...
declare @buildingarea decimal
set @cityid=6
set @fxtcompanyid=25
set @projectid=45609
set @typecode=1003002
set @datebegin='2016/8/18'
set @dateend='2017/2/22 0:00:00'
set @buildingarea=100
...
select
	...
	CAST(DateName(YEAR,tb.EndDate) AS nvarchar(10))+'Äê' EndDate,
