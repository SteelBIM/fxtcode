select B.BuildDate,H.*,c.CodeName as purposecodename,c1.CodeName as housetypecodename,c2.propertynumber from (
...
left join FxtData_Human.dbo.DAT_HumanHouse c2 on h.houseid = c2.HouseId