...
namespace FxtCenterService.Logic
{
    public class DatBizOfficeBL
    {
        ...
        {
            var result = DatBizOfficeDA.GetCaseListLand(search, landno, landclassname, landclasscode, minBuildingArea, maxBuildingArea, minUnitPrice, maxUnitPrice, landPurposeDesc, areaid, subareaid, startCaseDate, endCaseDate);
            return result;
        }
