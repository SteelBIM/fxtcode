...
namespace CAS.Entity.DBEntity
{
    public class Dat_ChargeEntrust : BaseTO
    {
        ...
        /// 业务总已收金额，不按条件
        /// </summary>
        public decimal? realityreceivesum
        {
            get;
            set;
        }
        ...
        public int tschargetimeout { get; set; }
        public int kpchargetimeout { get; set; }
        ...
        /// </summary>
        [SQLReadOnly]
        public string reportstagename { get; set; }
        ...
        /// </summary>
        [SQLReadOnly]
        public int maxtschargtimeoutday { get; set; }
        /// <summary>
        /// 最大报告开票超时天数
        /// </summary>
        [SQLReadOnly]
        public int maxkpchargtimeoutday { get; set; }
        /// <summary>
        /// 返利
        /// </summary>
        [SQLReadOnly]
        ...
        /// </summary>
        [SQLReadOnly]
        public int? totalreturnnumber
        {
            get;
            set;
        }
        /// <summary>
        /// 是否销案 Alex 增加 2015-09-11
        /// </summary>
        [SQLReadOnly]
        public int? isclosecase
        { get; set; }
        
        /// <summary>
        /// 是否销案说明 Alex 增加 2015-09-11
        /// </summary>
        [SQLReadOnly]
        public string closecasedesc
        { get; set; }
        /// <summary>
        /// 票据编号 Alex 增加 2015-09-15
        /// </summary>
        [SQLReadOnly]
        ...
        /// <summary>
        /// 投递状态 Alex 增加 2015-09-15
        /// </summary>
        [SQLReadOnly]
        public string deliverstatus { get; set; }

        /// <summary>
        /// 投递份数 Alex 增加 2015-09-15
        /// </summary>
        [SQLReadOnly]
        public int? totaldelivercount { get; set; }

        /// <summary>
        /// 投送时间 Alex 增加 2015-09-15
        /// </summary>
        [SQLReadOnly]
        public string deliverdate { get; set; }
        /// <summary>
        /// 签收状态 Alex 增加 2015-09-15
        /// </summary> 
        [SQLReadOnly]
        public string isreceive { get; set; }
        /// <summary>
        /// 是否退还 Alex 增加 2015-09-15
        /// </summary>
        [SQLReadOnly]
        public string isreturn { get; set; }
        /// <summary>
        /// 投递退还时间 Alex 增加 2015-09-15
        /// </summary>
        [SQLReadOnly]
        public string deliverreturndate { get; set; }

        /// <summary>
        /// 优惠类型子类别 Alex 增加 2015-09-24
        /// </summary>
        [SQLReadOnly]
        public int? privilegesubtype { get; set; }
        ...
        /// <summary>
        /// 收入支出创建时间 Alex 2016-09-26
        /// </summary>
        [SQLReadOnly]
        public DateTime inoutcreatetime { get; set; }
        /// <summary>
        /// 业务创建时间 Alex 2016-09-26
        /// </summary>
        [SQLReadOnly]
