...
; (function ($) {
    $.contextMenu = {
        ...
        create: function (menu, opts) {
            ...
            $('body').bind('mouseup', function () { cmenu.hide(); }); // If right-clicked somewhere else in the document, hide this menu
            return cmenu;
        },
        ...
        createMenuItem: function (label, obj) {
            ...
            var $idiv = $('<div class="' + cmenu.innerDivClassName + ' ' + iconStyle + '">' + label + '</div>');
            $div.append($idiv);
            return $div;
        },
