...
namespace CAS.Common
{
    ...
    public class JSONHelper
    {
        ...
        /// <summary>
        /// 将数据表转换成list集合
        /// 扩展属性:exceptIndex 排除要转换的集合
        /// kingfer 20161114
        /// </summary>
        /// <param name="dt">数据表</param>
        /// <param name="exceptIndex">排除显示的列索引</param>
        /// <returns></returns>
        public static List<Dictionary<string, object>> DataTableToOrderList(DataTable dt,int exceptIndex)
        {
            List<Dictionary<string, object>> list = new List<Dictionary<string, object>>();
            if (dt != null && dt.Rows.Count > 0)
            {
