...
namespace CAS.Common
{
    ...
    public class SurveyDataCommon
    {
        ...
        /// <param name="showimg">是否显示查勘图片</param>
        /// <returns></returns>
        public static List<SurveyExt>FxtSurvey_GetSurvey(LoginInfoEntity logininfo, int fxtcompanyid, int bankid, long sid, long entrustid, long objectid, int systypecode, out string msg, int statecode = 0, int showimg = 0)
        {
            ...
            if (!string.IsNullOrEmpty(api))
            {
                ...
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&bankid={9}&userid={2}&username={3}&password={4}&systypecode={5}&sid={6}&entrustid={7}&objectid={8}&statecode={10}&showimg={11}"
                    , (sid > 0 ? "surveyinfo" : "getinfobyobj"), fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, sid, entrustid, objectid, bankid, statecode, showimg), true);
                if (!string.IsNullOrEmpty(str))
                {
                    JSONHelper.ReturnData rtn = JSONHelper.JSONToObject<JSONHelper.ReturnData>(str);
                    LogHelper.Info(rtn.returntext.ToString());
                    if (rtn.returntype > 0)
                    {
                        if (sid > 0)
                        {
        ...
        /// </summary>
        /// <param name="logininfo"></param>
        /// <param name="sidlist">查勘ID</param>
        /// <param name="systypecode"></param>
        /// <param name="msg"></param>
        /// <returns></returns>
        public static List<DatSurveyHouse> FxtSurvey_GetSurveyHouse(LoginInfoEntity logininfo, List<long> sidlist, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            if (!string.IsNullOrEmpty(api))
            {
                ...
                {
                    sidlist.Select(o => sidstr += "," + o).ToList();
                }
                string url = api + "handlers/survey_info.ashx";
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&sid={6}"
                    , "getsurveyhouse", logininfo.fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, sidstr), true);
                if (!string.IsNullOrEmpty(str))
                {
                    JSONHelper.ReturnData rtn = JSONHelper.JSONToObject<JSONHelper.ReturnData>(str);
                    if (rtn.returntype > 0)
                    {
                        return JSONHelper.JSONStringToList<DatSurveyHouse>(JSONHelper.ObjectToJSON(rtn.data));
                    }
                    else
                    {
                        msg = "-1";
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static int FxtSurvey_GetSurveyAddFileCnt(LoginInfoEntity logininfo, int fxtcompanyid, long sid, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            if (!string.IsNullOrEmpty(api))
            {
                string url = api + "handlers/datfiles.ashx";
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&sid={6}"
                    , "getaddcnt", fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, sid), true);
                if (!string.IsNullOrEmpty(str))
                {
                    JSONHelper.ReturnData rtn = JSONHelper.JSONToObject<JSONHelper.ReturnData>(str);
                    if (rtn.returntype > 0)
                    {
                        ...
                        return StringHelper.TryGetInt(rtn.data.ToString());
                    }
                    else
                    {
                        msg = "-1";
       ...
       /// <param name="msg"></param>
       /// <returns></returns>
        public static string FxtSurvey_CheckSurveyFields(LoginInfoEntity logininfo, int typecode, int btfsid,  string showname, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            ...
            {
                string url = api + "handlers/survey_template_info.ashx";
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&typecode={6}&btfsid={7}&showname={8}"
                    , "checkfield", logininfo.fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, typecode, btfsid,  showname), true);
                if (!string.IsNullOrEmpty(str))
                {
                    return str;
                }
        ...
        /// <summary>
        /// 获取查勘模版系统字段关联CODE（DataTable JSON）
        /// </summary>
        /// <param name="logininfo"></param>
        /// <param name="typecode">类型</param>
        /// <param name="systypecode"></param>
        /// <param name="msg"></param>
        /// <returns></returns>
        public static string FxtSurvey_GetSurveyFieldsCodeData(LoginInfoEntity logininfo, int typecode, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            if (!string.IsNullOrEmpty(api))
            {
                ...
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&typecode={6}"
                    , "fieldcode", logininfo.fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, typecode), true);
                if (!string.IsNullOrEmpty(str))
                {
                    JSONHelper.ReturnData rtn = JSONHelper.JSONToObject<JSONHelper.ReturnData>(str);
                    if (rtn.returntype > 0)
                    {
                        ...
                        return JSONHelper.ObjectToJSON(rtn.data);
                    }
                    else
                    {
                        msg = "-1";
        ...
        /// <param name="systypecode"></param>
        /// <param name="surveytype">查勘类型</param>
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static List<SurveyImageTemplateExt> FxtSurvey_GetSurveyPhotoTemplateList(LoginInfoEntity logininfo, int companyid, int cityid, int systypecode
           , int surveytype, int pageindex, int pagerecords, string sortname, string sortorder //分页参数
            , out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            ...
            if (!string.IsNullOrEmpty(api))
            {
                ...
                string poststr = string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&cityid={6}"
                    , "list", companyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, cityid);
                poststr += "&surveytype=" + surveytype;
                if (pageindex > 0) poststr += "&pageindex=" + pageindex;
                if (pagerecords > 0) poststr += "&pagerecords=" + pagerecords;
                poststr += "&sortname=" + sortname;
                poststr += "&sortorder=" + sortorder;
                string str = WebCommon.APIPostBack(url, poststr, true);
                if (!string.IsNullOrEmpty(str))
                {
                    JSONHelper.ReturnData rtn = JSONHelper.JSONToObject<JSONHelper.ReturnData>(str);
                    if (rtn.returntype > 0)
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static string FxtSurvey_DeleteSurveyPhotoTemplate(LoginInfoEntity logininfo, int id, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            if (!string.IsNullOrEmpty(api))
            {
                string url = api + "handlers/phototemplates.ashx";
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&id={6}"
                    , "delete", logininfo.fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, id), true);
                if (!string.IsNullOrEmpty(str))
                {
                    return str;
                }
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static string FxtSurvey_ModifyPhotoTemplate(LoginInfoEntity logininfo, int surveytype, int id, string name, int pagecount, string pagecontent, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            ...
            {
                string url = api + "handlers/phototemplates.ashx";
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&surveytype={6}&name={7}&pagecount={8}&pagecontent={9}&id={10}"
                    , "modify", logininfo.fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, surveytype, name, pagecount, pagecontent, id), true);
                if (!string.IsNullOrEmpty(str))
                {
                    return str;
                }
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static string FxtSurvey_ModifyCode(LoginInfoEntity logininfo, string codes, string oids, int systypecode, out string msg)
        {
            //web.config设置调度中心API的地址
            string api = WebCommon.FxtSurveyCenterService;
            msg = string.Empty;
            ...
            {
                string url = api + "handlers/code.ashx";
                string str = WebCommon.APIPostBack(url, string.Format("type={0}&fxtcompanyid={1}&userid={2}&username={3}&password={4}&systypecode={5}&codes={6}&oids={7}"
                    , "mulmodify", logininfo.fxtcompanyid, logininfo.id, logininfo.username, logininfo.userpwd, systypecode, codes, oids), true);
                if (!string.IsNullOrEmpty(str))
                {
                    return str;
                }
