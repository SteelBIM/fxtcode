...
namespace CAS.Entity.DBEntity
{
	...
	public class DatObjectHouse : BaseTO
	{
		...
		private decimal _gardenarea = 0M;
		/// <summary>
		/// 花园面积
		/// </summary>
		...
		private decimal _subhousearea = 0M;
		/// <summary>
		/// 附属房屋面积
		/// </summary>
		...
		private decimal _subhouseunitprice = 0M;
		/// <summary>
		/// 附属房屋单价
		/// </summary>
		...
		private decimal _subhousetotalprice = 0M;
		/// <summary>
		/// 附属房屋总价
		/// </summary>
