...
namespace CAS.Entity.GJBEntity
{
    public class Dat_MoreQuery:DatMoreQuery
    {
        ...
        /// <summary>
        /// 当前处理人 Alex 2016-04-14
        /// </summary>
        [SQLReadOnly]
        public string currenthandleruser { get; set; }
        /// <summary>
        /// 查勘状态名称  Alex 2016-06-08
        /// </summary>
        [SQLReadOnly]
        public string surveystatename { get; set; }
        /// <summary>
        /// 物业名称  Alex 2016-06-08
        /// </summary>
        [SQLReadOnly]
        public string objnamearray { get; set; }
        
        /// <summary>
        /// 法定用途-冗余字段 rock 20161202
        /// </summary>
        [SQLReadOnly]
        public string statutoryPurposes { get; set; }
        /// <summary>
        /// 物业类型-冗余字段 
        /// </summary>
        [SQLReadOnly]
        public string querytypecodesname { get; set; }
        /// <summary>
        /// 第一个委估对象的价格-冗余字段 如果是土地类型，单价显示土地单价
        /// </summary>
        [SQLReadOnly]
        public decimal fristobjectunitprice { get; set; }
        /// <summary> 
        /// 土地总面积
        /// </summary>
        [SQLReadOnly]
        public decimal alllandarea { get; set; }
        /// <summary> 
        /// 委估对象个数 Alex 2016-06-08
        /// </summary>
         [SQLReadOnly]
        public int objnumber { get; set; }
         ...
         /// </summary>
         [SQLReadOnly]
         public decimal? loanablenum { get; set; }
         ...
         /// </summary>
         [SQLReadOnly]
         public string appraisersusersign { get; set; }
    }
