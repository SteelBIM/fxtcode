...
namespace CAS.Entity.SurveyDBEntity
{
    ...
    public class DatSurveyLand : BaseTO
    {
        ...
        private string _usenature;
        /// <summary>
        /// 使用权性质
        /// </summary>
        public string usenature
        {
            get { return _usenature; }
            set { _usenature = value; }
        }
        ...
        private string _maxcubagerate;
        /// <summary>
        /// 最大容积率
        /// </summary>
        public string maxcubagerate
        {
            get { return _maxcubagerate; }
            set { _maxcubagerate = value; }
        }
        private string _mincubagerate;
        /// <summary>
        /// 最小容积率
        /// </summary>
        public string mincubagerate
        {
            get { return _mincubagerate; }
            set { _mincubagerate = value; }
        }
        private string _maxcoverrate;
        /// <summary>
        /// 最大覆盖率
        /// </summary>
        public string maxcoverrate
        {
            get { return _maxcoverrate; }
            set { _maxcoverrate = value; }
        }
        private string _greenrate;
        /// <summary>
        /// 绿化率
        /// </summary>
        ...
        private string _mingreenrate;
        /// <summary>
        /// 最小绿化率
        /// </summary>
        public string mingreenrate
        {
            get { return _mingreenrate; }
            set { _mingreenrate = value; }
        }
        private string _usesituation;
        /// <summary>
        /// 土地利用状况
        /// </summary>
        public string usesituation
        {
            get { return _usesituation; }
            set { _usesituation = value; }
        }
        private string _buildinglimithigh;
        /// <summary>
        /// 建筑物限高
        /// </summary>
        public string buildinglimithigh
        {
            get { return _buildinglimithigh; }
            set { _buildinglimithigh = value; }
        }
        ...
        private string _shoppingcenterdistance;
        /// <summary>
        /// 距离商服中心距离
        /// </summary>
        public string shoppingcenterdistance
        {
            get { return _shoppingcenterdistance; }
            set { _shoppingcenterdistance = value; }
        }
        private string _environmentquality;
        /// <summary>
        /// 环境质量
        /// </summary>
        public string environmentquality
        {
            get { return _environmentquality; }
            set { _environmentquality = value; }
        }
        private string _licensetime;
        /// <summary>
        /// 许可证时间
        /// </summary>
        public string licensetime
        {
            get { return _licensetime; }
            set { _licensetime = value; }
        }
        private string _parcelconditions;
        /// <summary>
        /// 宗地自身条件
        /// </summary>
        public string parcelconditions
        {
            get { return _parcelconditions; }
            set { _parcelconditions = value; }
        }
        private string _landpriceindex;
        /// <summary>
        /// 地价指数
        /// </summary>
        public string landpriceindex
        {
            get { return _landpriceindex; }
            set { _landpriceindex = value; }
        }
