...
namespace CAS.Entity
{
    ...
    public class SurveyApi
    {
        ...
        public SurveyApi(LoginInfoEntity userContext, string sysTypeCode, string appId)
            :this(userContext.apps, userContext.signname, userContext.username, userContext.userpwd, userContext.fxtcompanyid, userContext.subcompanyid, sysTypeCode, appId)
        {
            ...
            //    }
            //}
            //_sInfo = new SecurityInfo(userContext.signname, appId, appPwd, appKey);
            //_info = new AllInfo(userContext.username,userContext.userpwd,userContext.fxtcompanyid,userContext.subcompanyid, sysTypeCode);

        }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="loginApps"></param>
        /// <param name="loginSignname"></param>
        /// <param name="loginUsername"></param>
        /// <param name="loginUserpwd"></param>
        /// <param name="loginFxtcompanyid"></param>
        /// <param name="loginSubcompanyid"></param>
        /// <param name="sysTypeCode"></param>
        /// <param name="appId"></param>
        public SurveyApi(List<Apps> loginApps, string loginSignname, string loginUsername, string loginUserpwd, int loginFxtcompanyid, int loginSubcompanyid, string sysTypeCode, string appId)
        {
            _jss.MaxJsonLength = 10240000;
            List<Apps> apps = loginApps;
            string appPwd = "",
                appKey = "";
            if (null != apps && 0 < apps.Count)
            {
            ...
            _sInfo = new SecurityInfo(loginSignname, appId, appPwd, appKey);
            _info = new AllInfo(loginUsername, loginUserpwd, loginFxtcompanyid, loginSubcompanyid, sysTypeCode);
    ...
    public class SecurityInfo
    {
        ...
        /***gjbapi项目引用**/
        public SecurityInfo(LoginInfoEntity userContext, string appId, string appPwd, string appKey):this(userContext.signname,appId,appPwd,appKey)
        {
            //_signName = userContext.signname;
            //_appId = appId;
            //_appPwd = appPwd;
    ...
    public class AllInfo
    {
        ...
        public AllInfo(LoginInfoEntity userContext, string sysTypeCode):this(userContext.username, userContext.userpwd, userContext.fxtcompanyid, userContext.subcompanyid, sysTypeCode)
        {
            //_uinfo = new UserInfo(userContext.username,userContext.userpwd,userContext.fxtcompanyid,userContext.subcompanyid);
            //_appinfo = new ApplicationInfo(sysTypeCode);
        }

        public AllInfo(string username, string userpwd, int fxtcompanyid, int subcompanyid, string sysTypeCode)
        {
            _uinfo = new UserInfo(username, userpwd, fxtcompanyid, subcompanyid);
            _appinfo = new ApplicationInfo(sysTypeCode);
        }
    ...
    public class UserInfo
    {
        ...
        public UserInfo(LoginInfoEntity userContext)
            : this(userContext.username, userContext.userpwd, userContext.fxtcompanyid, userContext.subcompanyid)
        {
        ...
        public UserInfo(string username, string userpwd, int fxtcompanyid, int subcompanyid)
        {
            this._username = username;
            this._password = userpwd;
            this._fxtcompanyid = fxtcompanyid;
            this._subcompanyid = subcompanyid;
        }
