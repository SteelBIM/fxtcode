...
namespace CAS.Entity.DBEntity
{
    ...
    public class DatMoreQuery : BaseTO
    {
        ...
        /// <summary>
        /// 人工询价审批类型，针对委估对象发起  0:没有审批（价格纠错或价格争议）  1:价格纠错  2：价格争议 
        /// </summary>
        ...
        private decimal? _unifiedpriceonrequest;
        /// <summary>
        /// 统一回价业务员要求总价 Alex 2015-11-27
        /// </summary>
        public decimal? unifiedpriceonrequest
        {
            get { return _unifiedpriceonrequest; }
            set { _unifiedpriceonrequest = value; }
        }

        private decimal? _unifiedpricedisputeamount;
        /// <summary>
        /// 统一回业务员要求幅度 Alex 2015-11-27
        /// </summary>
        public decimal? unifiedpricedisputeamount
        {
            get { return _unifiedpricedisputeamount; }
            set { _unifiedpricedisputeamount = value; }
        }

        private int? _surveystate;
        /// <summary>
        /// 查勘状态 Alex 2016-06-08
        /// </summary>
