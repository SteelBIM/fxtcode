...
namespace CAS.Common.MVC4
{
    public class LogHelper
    {
        public static log4net.ILog CASLog {
            get {
                string logConfigFile = "log.config";
                if (!System.IO.File.Exists(AppDomain.CurrentDomain.BaseDirectory + logConfigFile))
                {
                    logConfigFile = "log4net.config";
                }
                log4net.Config.XmlConfigurator.Configure(new System.IO.FileInfo(AppDomain.CurrentDomain.BaseDirectory + logConfigFile));
