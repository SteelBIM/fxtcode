...
namespace CAS.Common
{
    public class ConstCommon
    {
        ...
        /// CAS
        /// </summary>
        public const int SYSTYPECODE_CAS = 1003001;
        #endregion
        //Api类
        #region 系统类型
        /// <summary>
        ...
        /// 微信token缓存时间（分）
        /// </summary>
        public const int WXTokenCacheInterval = 110;
        /// <summary>
        /// 微信token缓存key
        /// </summary>
        public const string WXTokenCacheKey = "WXToken_{0}";
        /// <summary>
        /// 系统管理员账号
        /// </summary>
        ...
        public const string DefaultMenuBackColor = "#3083eb";// "#566FAD" rock 20160622 改版后#3083eb;
        ...
        /// Cmb用户密码加密的Key
        /// </summary>
        public const string CmbWcfPassWordMd5Key = "Cmbfxtproduct*&2014";

        /// <summary>
        /// 用户账号加密的Key
        /// </summary>
        public const string WcfUserNameMd5Key = "fxtusername*&2014";
        /// <summary>
        /// 系统检测到您的密码存在风险，请立即修改
        /// </summary>
        public const string WcfSimpleTip = "系统检测到您的密码存在风险，请立即修改！";

        /// <summary>
        /// 您的新密码仍然存在风险，请更换重试
        /// </summary>
        public const string WcfNewPassWordIsNotSafe = "您的新密码仍然存在风险，请更换重试！";
        /// <summary>
        /// Apppwd加密的Key
        /// </summary>
        ...
        /// 定义匿名方法获取当前的机构ID
        /// </summary>
        public static Func<int> GetFxtCompanyId = delegate() { return 0; };
    }
    ...
    public class CacheKey
    {
        ...
        /// <summary>
        /// 委估对象 单行 kingfer 20161009
        /// </summary>
        public const string FieldsTableObjectSingleRow = "FieldsTable_singleRow_{0}_2018002_{1}_200106003";
        /// <summary>
        /// 询价客户信息 kevin
        /// </summary>
        ...
        /// 人工询价客户信息 kevin
        /// </summary>
        public const string FieldsTableMoreQuery = "FieldsTable_{0}_2018010_0_200106001";
        /// <summary>(int)EnumDataType.多套询价
        /// 委托信息 kevin
        /// </summary>
        ...
        /// 案例数据 ben
        /// </summary>
        public const string FieldsTableCase = "FieldsTable_{0}_2018011_{1}_200106005";
        /// <summary>
        /// 价格纠错 潘锦发
        /// </summary>
        public const string FieldsTablePriceAjust = "FieldsTable_{0}_2018014_0_200106006";
        /// <summary>
        /// 价格争议 潘锦发
        /// </summary>
        public const string FieldsTablePriceDispute = "FieldsTable_{0}_2018015_0_200106007";
        /// <summary>
        /// 博纳金融业务 Alex  2015-12-14
        /// </summary>
        public const string FieldsTableBoNaMortgageEntrust = "FieldsTable_{0}_2018016_{1}_200106008";
        
        /// <summary>
        /// 博纳金融业务委估对象 Alex  2015-12-14
        /// </summary>
        public const string FieldsTableBoNaMortgageObject = "FieldsTable_{0}_2018017_{1}_200106009";

        /// <summary>
        /// 省份缓存key
        /// </summary>
        public const string SysProvince = "SysProvince";
        /// <summary>
        /// 城市缓存key
        /// </summary>
        public const string SysCity = "SysCity";
        /// <summary>
        /// 区域缓存key
        /// </summary>
        public const string SysArea = "SysArea";
        /// <summary>
        /// 用户缓存
        /// </summary>
        public const string SysUser = "SysUser_{0}";
        /// <summary>
        /// 分支机构缓存
        /// </summary>
        public const string SysSubCompanyList = "SysSubCompanyList_{0}";
        /// <summary>
        /// 客户信息缓存
        /// </summary>
        public const string SysCustomerCompanyList = "SysCustomerCompanyList_{0}";
        /// <summary>
        /// 询价ID缓存
        /// </summary>
        public const string QueryId = "QueryId_{0}";
        /// <summary>
        /// 询价ID缓存
        /// </summary>
        public const string EntrustId = "EntrustId_{0}";
        /// <summary>
        /// 列表字段缓存 kingfer 20161219
        /// </summary>
        public const string SysDataListCookies = "SysDataListCookies_{0}";

        public const string UserCenterCompanyList = "UserCenterCompanyList";
    }
