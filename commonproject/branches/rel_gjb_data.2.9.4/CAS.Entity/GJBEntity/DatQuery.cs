...
namespace CAS.Entity.GJBEntity
{
    public class Dat_Query : DatQuery
    {
       ...
       [SQLReadOnly]
        ...
        /// <summary>
        /// 当前处理人  Alex 2016-04-20
        /// </summary>
        [SQLReadOnly]
        public string currenthandleruser { get; set; }

        /// <summary>
        /// 纠错人姓名 Alex 2016-08-09
        /// </summary>
        [SQLReadOnly]
        public string adjustersusername { get; set; }
        /// <summary>
        ...
        /// <summary> 
        /// 委估对象个数(装载统计时的多套) rock 2016-12-29
        /// </summary>
        [SQLReadOnly]
    ...
    /// 业务量统计
    /// </summary>
    public class AppraisersStatistics : BaseTO
    {
