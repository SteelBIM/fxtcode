...
{
    [Serializable]
    [TableAttribute("FxtUserCenter.dbo.CompanyProduct")]
    public class CompanyProduct : BaseTO
    {
        ...
        private int _maxaccountnumber = 0;
        /// <summary>
        /// 产品开通用户最大数量
        /// </summary>
        public int maxaccountnumber
        {
            get { return _maxaccountnumber; }
            set { _maxaccountnumber = value; }
        }

        private int? _parentproducttypecode;
        /// <summary>
        /// 用于查数据的typecode
        /// </summary>
        public int? parentproducttypecode
        {
            get { return _parentproducttypecode; }
            set { _parentproducttypecode = value; }
        }

        private int? _parentshowdatacompanyid;
        /// <summary>
        /// 用于查数据的companyid
        /// </summary>
        public int? parentshowdatacompanyid
        {
            get { return _parentshowdatacompanyid; }
            set { _parentshowdatacompanyid = value; }
        }
    }
}