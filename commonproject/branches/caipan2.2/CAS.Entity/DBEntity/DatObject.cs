...
namespace CAS.Entity.DBEntity
{
	...
	public class DatObject : BaseTO
	{
        ...
        #region 产权人信息字段 由于开始属于Object表所以没有移除这个实体类
        ...
        private string _ownercontacts;
        /// <summary>
        /// 产权人联系人
        /// </summary>
        public string ownercontacts
        {
            get { return _ownercontacts; }
            set { _ownercontacts = value; }
        }
        ...
        private string _realestateno;
        /// <summary>
        /// 不动产权证号
        /// </summary>
        public string realestateno
        {
            get { return _realestateno; }
            set { _realestateno = value; }
        }
        private string _realestateunitno;
        /// <summary>
        /// 不动产单元号
        /// </summary>
        public string realestateunitno
        {
            get { return _realestateunitno; }
            set { _realestateunitno = value; }
        }
