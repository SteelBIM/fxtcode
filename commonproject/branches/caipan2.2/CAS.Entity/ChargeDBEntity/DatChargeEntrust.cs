...
namespace CAS.Entity.DBEntity
{
    ...
    public class DatChargeEntrust : BaseTO
    {
        ...
        private int? _privilegesubtype;
        /// <summary>
        /// 增加优惠类型子类别，用来标识 优惠类型（privilegetype） 下的优惠子类别 1代表一口价按折扣 2代表一口价按金额 Alex 2015-09-24        
        /// </summary>
        public int? privilegesubtype
        {
            get { return _privilegesubtype; }
            set { _privilegesubtype = value; }
        }
