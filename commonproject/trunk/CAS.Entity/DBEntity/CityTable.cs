...
namespace CAS.Entity.DBEntity
{
    ...
    public class CityTable : BaseTO
    {
        ...
        private string _weightproject;
        /// <summary>
        /// 楼盘均价的修正系数
        /// </summary>
        public string weightproject
        {
            get { return _weightproject; }
            set { _weightproject = value; }
        }
        private string _weightbuilding;
        /// <summary>
        /// 楼栋均价修正系数
        /// </summary>
        public string weightbuilding
        {
            get { return _weightbuilding; }
            set { _weightbuilding = value; }
        }
        private string _weighthouse;
        /// <summary>
        /// 房号均价修正系数
        /// </summary>
        public string weighthouse
        {
            get { return _weighthouse; }
            set { _weighthouse = value; }
        }

        private string _projectavgtable;
        /// <summary>
        /// 楼盘案例均价
        /// </summary>
        public string projectavgtable
        {
            get { return _projectavgtable; }
            set { _projectavgtable = value; }
        }
    }
}
