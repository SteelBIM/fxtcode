...
namespace CAS.Entity.GJBEntity
{
    public class Dat_YP : DatYP
    {
        ...
        /// </summary>
        [SQLReadOnly]
         public string rname_ypprintuser { get; set; }
        /// <summary>
        /// 冗余字段，预评盖章人
        /// </summary>
        [SQLReadOnly]
        public string rname_ypsealuser { get; set; }

        /// <summary>
        /// 预评报告归档资料负责人 Alex 2016-08-03
        /// </summary>
        [SQLReadOnly]
    ...
    public class TabBubble : BaseTO
    {
        ...
        /// 待收费
        /// </summary>
        public int daishoufei { get; set; }

        /// <summary>
        /// 待结单
        /// </summary>
        public int daijiedan { get; set; }

        /// <summary>
        /// 待结算
        /// </summary>
        public int daijiesuan { get; set; }

        /// <summary>
        /// 待退费
        /// </summary>
        public int daituifei { get; set; }
