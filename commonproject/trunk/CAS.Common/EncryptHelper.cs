...
namespace CAS.Common
{
    public class EncryptHelper
    {
       ...
       /// <returns></returns>
        ...
        /// <returns></returns>
        public static string ProjectIdEncrypt(string projectid)
        {
            return Encrypt(projectid, "fxtsys15");
        }
        /// <summary>
        /// 密码解密函数
        /// </summary>
        ...
        /// <returns></returns>
        public static int ProjectIdDecrypt(string ciphertext)
        {
            int projectid = StringHelper.TryGetInt(Decrypt(ciphertext, "fxtsys15"));
            return projectid;
        }
