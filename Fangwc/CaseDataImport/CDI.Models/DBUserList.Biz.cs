...
namespace CDI.Models
{
    ...
    public partial class DBUserList : Entity<DBUserList>
    {
        #region 对象操作
        #endregion
        ...
        #region 扩展查询
        /// <summary>根据可查询用户名查找</summary>
        /// <param name="username">可查询用户名</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<DBUserList> FindAllByUserName(String username)
        {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<DBUserList> FindAllByProductCode(String productcode)
        {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static DBUserList FindByID(Int32 id)
        {
            return Find(_.ID, id);
            //if (Meta.Count >= 1000)
            //    return Find(_.ID, id);
        ...
        //public static EntityList<DBUserList> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
