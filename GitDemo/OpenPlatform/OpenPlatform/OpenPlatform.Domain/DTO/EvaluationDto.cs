...
namespace OpenPlatform.Domain.DTO
{
    public class EvaluationDto
    {
        ...
        #region 委估对象
        public List<EntrustObjectDto> EntrustObject { get; set; }
        #endregion
    ...
    public class EntrustObjectDto
    {
        ...
        #region 产权信息
        public List<PropertyInfoDto> PropertyInfo { get; set; }
        #endregion

        #region 买房人信息
        public IList<BuyerInfoDto> BuyerInfo { get; set; }
        #endregion
    }
