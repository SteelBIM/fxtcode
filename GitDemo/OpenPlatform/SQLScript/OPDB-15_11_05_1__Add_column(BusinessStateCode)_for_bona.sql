/*
Date: 20151105
Description: 博纳业务，新增委托业务状态字段
*/

USE openplatform;

-- sys_code表新增CODE
INSERT INTO sys_code VALUES (NULL, 10013001, '待提交', 10013, '委托业务状态(src: FxtOA.SYS_CODE)')
			,(NULL, 10013002, '待分配', 10013, '委托业务状态(src: FxtOA.SYS_CODE)')
			,(NULL, 10013003, '处理中', 10013, '委托业务状态(src: FxtOA.SYS_CODE)')
			,(NULL, 10013004, '已完成', 10013, '委托业务状态(src: FxtOA.SYS_CODE)')
			,(NULL, 10013005, '已撤销', 10013, '委托业务状态(src: FxtOA.SYS_CODE)');


-- entrust_appraise表新增字段BusinessStateCode
ALTER TABLE entrust_appraise ADD BusinessStateCode INT NULL COMMENT '委托业务状态';
