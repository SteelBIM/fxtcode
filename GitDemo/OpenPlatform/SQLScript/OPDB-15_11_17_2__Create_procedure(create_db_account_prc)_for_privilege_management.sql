/*
Date: 20151117
Description: 新建存储过程：新建、修改、查询用户帐号信息，
	同时修改mysql.userinfo表存储的用户信息
*/

-- 修改mysql.userinfo表结构
ALTER TABLE mysql.userinfo DROP PRIMARY KEY
	,ADD PRIMARY KEY(`username`, `host`)
	,DROP COLUMN id;
...
CREATE PROCEDURE create_db_account_prc(
