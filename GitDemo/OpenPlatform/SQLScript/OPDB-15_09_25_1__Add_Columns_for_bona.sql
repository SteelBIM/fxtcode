/*
Date: 20150925
Description: 博纳新增字段，修改syscode表名
*/

-- 修改表名
ALTER TABLE syscode RENAME sys_code;

-- 博纳新增字段
ALTER TABLE entrust_appraise ADD AppraisePurpose VARCHAR(150) COMMENT '评估目的' AFTER BuyingType;
...
CREATE PROCEDURE `process_entrust_data_prc`(
    ...
    ,IN v_appraisepurpose VARCHAR(50)	-- 评估目的
    )
    MODIFIES SQL DATA
