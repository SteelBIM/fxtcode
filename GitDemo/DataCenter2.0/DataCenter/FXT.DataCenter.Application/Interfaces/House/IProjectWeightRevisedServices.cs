...
namespace FXT.DataCenter.Application.Interfaces.House
{
    public interface IProjectWeightRevisedServices
    {
        ...
        /// <returns></returns>
        IQueryable<DatWeightProject> GetWeightProjects(DatWeightProject datWeightProject, int pageIndex, int pageSize, out int totalCount, bool self = true);
        ...
        /// <returns></returns>
        DatWeightProject GetWeightProject(int id,int projectId, int cityId, int fxtCompanyId);
        ...
        /// <param name="fxtCompanyId"></param>
        /// <returns></returns>
        long GetWeightProjectByProjectId(int projectId, int cityId, int fxtCompanyId);
        ...
        /// <param name="self"></param>
        /// <returns></returns>
        IQueryable<DatWeightProject> GetNotUpdatedAvrPriceProjects(DatWeightProject datWeightProject, bool self = true);
