...
$(function () {
    ...
    var firstModule = ["/Authorize/", "/Land/", "/House/", "/Business/", "/Office/", "/Industry/", "/Human/", "/VQPrice/", "/Company/"];
    ...
    if (url.indexOf(firstModule[8]) > 0) {
        $("ul.navbar-nav").find("li").eq(8).addClass("active").find("a").append("<span class=\"selected\"></span>");
    }
