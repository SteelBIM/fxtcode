    ...
    */
    SetFloorAvgPrice: function (avgpriceFloor) {
        if (this.AveragePrice == null || this.AveragePrice == "") {
            alert("温馨提示:楼栋均价不正确，请先到“价格系数”页设置项目均价和楼栋均价!");
            return false;
        }
   ...
   */
    ...
    Submit: function (thisobj) {
        ...
        */
        ...
        $.ajax({
            url: "/Industry/IndustryHouse/Save",
            ...
            success: function (jsondata) {
                window.location.href = "/Industry/IndustryHouse/Index?buildingId=" + HouseObj.BuildingId + "&projectId=" + HouseObj.ProjectId;
            },
...
function SetPriceWeight() {
    ...
    if (window.confirm("温馨提示:价格系数是由房号的单价与项目均价求得的，请确认房号单价和楼盘均价设置无误，是否继续？")) {
